...
Use LoopFunctions 
Use LoopMasses_BGLCS 
Use StandardModel 
Use RunSM_BGLCS
Use FlavorKit_LFV_BGLCS
Use FlavorKit_QFV_BGLCS
Use FlavorKit_Observables_BGLCS
...
Subroutine Gminus2(Ifermion,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,           & 
& cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,     & 
& cplcFv1FecHmL,cplcFv1FecHmR,cplcFv1FecVWmL,cplcFv1FecVWmR,cplcFv2FecHmL,               & 
& cplcFv2FecHmR,cplcFv2FecVWmL,cplcFv2FecVWmR,cplcFv3FecHmL,cplcFv3FecHmR,               & 
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcFeFv1HmL,cplcFeFv1HmR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,   & 
& cplcFeFv1VWmL,cplcFeFv1VWmR,cplcFeFv2HmL,cplcFeFv2HmR,cplcFv2Fv2VPL,cplcFv2Fv2VPR,     & 
& cplcFeFv2VWmL,cplcFeFv2VWmR,cplcFeFv3HmL,cplcFeFv3HmR,cplcFv3Fv3VPL,cplcFv3Fv3VPR,     & 
& cplcFeFv3VWmL,cplcFeFv3VWmR,cplHmcHmVP,cplcVWmVPVWm,a_mu)

Real(dp),Intent(in)  :: MAh(3),MAh2(3),MFe(3),MFe2(3),Mhh(3),Mhh2(3),MHm(2),MHm2(2),MVWm,MVWm2

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplAhhhVP(3,3),cplcFeFehhL(3,3,3),              & 
& cplcFeFehhR(3,3,3),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFv1FecHmL(3,2),               & 
& cplcFv1FecHmR(3,2),cplcFv1FecVWmL(3),cplcFv1FecVWmR(3),cplcFv2FecHmL(3,2),             & 
& cplcFv2FecHmR(3,2),cplcFv2FecVWmL(3),cplcFv2FecVWmR(3),cplcFv3FecHmL(3,2),             & 
& cplcFv3FecHmR(3,2),cplcFv3FecVWmL(3),cplcFv3FecVWmR(3),cplcFeFv1HmL(3,2),              & 
& cplcFeFv1HmR(3,2),cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcFeFv1VWmL(3),cplcFeFv1VWmR(3),       & 
& cplcFeFv2HmL(3,2),cplcFeFv2HmR(3,2),cplcFv2Fv2VPL,cplcFv2Fv2VPR,cplcFeFv2VWmL(3),      & 
& cplcFeFv2VWmR(3),cplcFeFv3HmL(3,2),cplcFeFv3HmR(3,2),cplcFv3Fv3VPL,cplcFv3Fv3VPR,      & 
& cplcFeFv3VWmL(3),cplcFeFv3VWmR(3),cplHmcHmVP(2,2),cplcVWmVPVWm
...
coup1L = cplcFeFv1HmL(gt1,i2)
coup1R = cplcFeFv1HmR(gt1,i2)
coup2L = cplcFv1FecHmL(gt2,i3)
coup2R = cplcFv1FecHmR(gt2,i3)
ratio = MHm2(i2)/0._dp
 chargefactor = chargefactor*(1._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
...
coup1L = cplcFeFv1VWmL(gt1)
coup1R = cplcFeFv1VWmR(gt1)
coup2L = cplcFv1FecVWmL(gt2)
coup2R = cplcFv1FecVWmR(gt2)
ratio = MVWm2/0._dp
 chargefactor = chargefactor*(1._dp)
 ratio = 1._dp/ratio ! conventions in 1402.7065 are different 
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - 4._dp*chargefactor*ratio*(Real(coup1L*Conjg(coup1R),dp)*gVVF(ratio)/0._dp& 
      & + 2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*fVVF(ratio)/0._dp) 
End if 
...
chargefactor = 1 
  Do i2= 2,2
   i3 = i2
  If ((0._dp.gt.mz2).Or.(MHm2(i2).gt.mz2).Or.(MHm2(i3).gt.mz2)) Then
coup1L = cplcFeFv2HmL(gt1,i2)
coup1R = cplcFeFv2HmR(gt1,i2)
coup2L = cplcFv2FecHmL(gt2,i3)
coup2R = cplcFv2FecHmR(gt2,i3)
ratio = MHm2(i2)/0._dp
 chargefactor = chargefactor*(1._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(2._dp*Real(coup1L*Conjg(coup1R),dp)*F4(ratio)/0._dp& 
...
chargefactor = 1 
  If ((0._dp.gt.mz2).Or.(MVWm2.gt.mz2).Or.(MVWm2.gt.mz2)) Then
coup1L = cplcFeFv2VWmL(gt1)
coup1R = cplcFeFv2VWmR(gt1)
coup2L = cplcFv2FecVWmL(gt2)
coup2R = cplcFv2FecVWmR(gt2)
ratio = MVWm2/0._dp
 chargefactor = chargefactor*(1._dp)
 ratio = 1._dp/ratio ! conventions in 1402.7065 are different 
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
...
chargefactor = 1 
  Do i2= 2,2
   i3 = i2
  If ((0._dp.gt.mz2).Or.(MHm2(i2).gt.mz2).Or.(MHm2(i3).gt.mz2)) Then
coup1L = cplcFeFv3HmL(gt1,i2)
coup1R = cplcFeFv3HmR(gt1,i2)
coup2L = cplcFv3FecHmL(gt2,i3)
coup2R = cplcFv3FecHmR(gt2,i3)
ratio = MHm2(i2)/0._dp
 chargefactor = chargefactor*(1._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(2._dp*Real(coup1L*Conjg(coup1R),dp)*F4(ratio)/0._dp& 
...
chargefactor = 1 
  If ((0._dp.gt.mz2).Or.(MVWm2.gt.mz2).Or.(MVWm2.gt.mz2)) Then
coup1L = cplcFeFv3VWmL(gt1)
coup1R = cplcFeFv3VWmR(gt1)
coup2L = cplcFv3FecVWmL(gt2)
coup2R = cplcFv3FecVWmR(gt2)
ratio = MVWm2/0._dp
 chargefactor = chargefactor*(1._dp)
 ratio = 1._dp/ratio ! conventions in 1402.7065 are different 
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
...
chargefactor = 1 
Do i1= 2,2
  If ((MHm2(i1).gt.mz2).Or.(0._dp.gt.mz2).Or.(0._dp.gt.mz2)) Then
coup1L = cplcFeFv1HmL(gt1,i1)
coup1R = cplcFeFv1HmR(gt1,i1)
coup2L = cplcFv1FecHmL(gt2,i1)
coup2R = cplcFv1FecHmR(gt2,i1)
ratio = MHm2(i1)/0._dp
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(Real(coup1L*Conjg(coup1R),dp)*F3gamma(ratio)/0._dp& 
      & - 2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F2(ratio)/0._dp) 
End if 
...
Do i1= 2,2
  If ((MHm2(i1).gt.mz2).Or.(0._dp.gt.mz2).Or.(0._dp.gt.mz2)) Then
coup1L = cplcFeFv2HmL(gt1,i1)
coup1R = cplcFeFv2HmR(gt1,i1)
coup2L = cplcFv2FecHmL(gt2,i1)
coup2R = cplcFv2FecHmR(gt2,i1)
ratio = MHm2(i1)/0._dp
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(Real(coup1L*Conjg(coup1R),dp)*F3gamma(ratio)/0._dp& 
...
Do i1= 2,2
  If ((MHm2(i1).gt.mz2).Or.(0._dp.gt.mz2).Or.(0._dp.gt.mz2)) Then
coup1L = cplcFeFv3HmL(gt1,i1)
coup1R = cplcFeFv3HmR(gt1,i1)
coup2L = cplcFv3FecHmL(gt2,i1)
coup2R = cplcFv3FecHmR(gt2,i1)
ratio = MHm2(i1)/0._dp
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(Real(coup1L*Conjg(coup1R),dp)*F3gamma(ratio)/0._dp& 
...
chargefactor = 1 
  If ((MVWm2.gt.mz2).Or.(0._dp.gt.mz2).Or.(0._dp.gt.mz2)) Then
coup1L = cplcFeFv1VWmL(gt1)
coup1R = cplcFeFv1VWmR(gt1)
coup2L = cplcFv1FecVWmL(gt2)
coup2R = cplcFv1FecVWmR(gt2)
ratio = MVWm2/0._dp
 ...
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - 8._dp*chargefactor*ratio*(Real(coup1L*Conjg(coup1R),dp)*gFFV(ratio)/0._dp& 
      & + 2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*fFFV(ratio)/0._dp) 
End if 
...
& MVWm2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplcFeFehhL,cplcFeFehhR,              & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFv1FecHmL,cplcFv1FecHmR,           & 
& cplcFv1FecVWmL,cplcFv1FecVWmR,cplcFv2FecHmL,cplcFv2FecHmR,cplcFv2FecVWmL,              & 
& cplcFv2FecVWmR,cplcFv3FecHmL,cplcFv3FecHmR,cplcFv3FecVWmL,cplcFv3FecVWmR,              & 
& cplcFeFv1HmL,cplcFeFv1HmR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcFeFv1VWmL,cplcFeFv1VWmR,     & 
& cplcFeFv2HmL,cplcFeFv2HmR,cplcFv2Fv2VPL,cplcFv2Fv2VPR,cplcFeFv2VWmL,cplcFeFv2VWmR,     & 
& cplcFeFv3HmL,cplcFeFv3HmR,cplcFv3Fv3VPL,cplcFv3Fv3VPR,cplcFeFv3VWmL,cplcFeFv3VWmR,     & 
& cplHmcHmVP,cplcVWmVPVWm,EDM)

Implicit None
Real(dp),Intent(in)  :: MAh(3),MAh2(3),MFe(3),MFe2(3),Mhh(3),Mhh2(3),MHm(2),MHm2(2),MVWm,MVWm2,MVZ,MVZ2

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplAhhhVP(3,3),cplcFeFehhL(3,3,3),              & 
& cplcFeFehhR(3,3,3),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),& 
& cplcFv1FecHmL(3,2),cplcFv1FecHmR(3,2),cplcFv1FecVWmL(3),cplcFv1FecVWmR(3),             & 
& cplcFv2FecHmL(3,2),cplcFv2FecHmR(3,2),cplcFv2FecVWmL(3),cplcFv2FecVWmR(3),             & 
& cplcFv3FecHmL(3,2),cplcFv3FecHmR(3,2),cplcFv3FecVWmL(3),cplcFv3FecVWmR(3),             & 
& cplcFeFv1HmL(3,2),cplcFeFv1HmR(3,2),cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcFeFv1VWmL(3),      & 
& cplcFeFv1VWmR(3),cplcFeFv2HmL(3,2),cplcFeFv2HmR(3,2),cplcFv2Fv2VPL,cplcFv2Fv2VPR,      & 
& cplcFeFv2VWmL(3),cplcFeFv2VWmR(3),cplcFeFv3HmL(3,2),cplcFeFv3HmR(3,2),cplcFv3Fv3VPL,   & 
& cplcFv3Fv3VPR,cplcFeFv3VWmL(3),cplcFeFv3VWmR(3),cplHmcHmVP(2,2),cplcVWmVPVWm
...
!ratio = 0._dp/MHm2(i1)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM -(0)* chargefactor*Aimag(coup1R*Conjg(coup1L))*FeynFunctionA(ratio)*0._dp/MHm2(i1) 
!End if 
 
ratio = MHm2(i1)/0._dp
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
EDM = EDM - 0.5_dp*chargefactor*(Aimag(coup1L*Conjg(coup1R))*F3gamma(ratio)/0._dp) 
End if 
...
ratio = MVWm2/0._dp
 ...
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
EDM = EDM - 4._dp*chargefactor*(Aimag(coup1L*Conjg(coup1R))*gFFV(ratio)/0._dp) 
End if 
...
& cplcFuFuVZR,cplcFv1FecVWmL,cplcFv1FecVWmR,cplcFv1Fv1VZL,cplcFv1Fv1VZR,cpl
cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,        & 
& cplcVWmcVWmVWmVWm3,cplcHmVWmVZ(2),cplcHmVPVWm(2),cplAhAhVPVZ(3,3),cplhhhhVPVZ(3,3),    & 
& cplHmcHmVPVZ(2,2),cplcVWmVPVWmVZ1,cplcVWmVPVWmVZ2,cplcVWmVPVWmVZ3
...
Call Pi1LoopVPVZ(MVZ2,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHm,               & 
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhVPVZ,cplAhhhVP,cplAhhhVZ,cplcFdFdVPL,cplcFdFdVPR,      & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,           & 
& cplcFv1Fv1VZL,cplcFv1Fv1VZR,cplcFv2Fv2VPL,cplcFv2Fv2VPR,cplcFv2Fv2VZL,cplcFv2Fv2VZR,   & 
& cplcFv3Fv3VPL,cplcFv3Fv3VPR,cplcFv3Fv3VZL,cplcFv3Fv3VZR,cplcgWmgWmVP,cplcgWmgWmVZ,     & 
& cplcgWpgWpVP,cplcgWpgWpVZ,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVPVWmVZ1,        & 
& cplcVWmVPVWmVZ2,cplcVWmVPVWmVZ3,cplcVWmVWmVZ,cplhhhhVPVZ,cplhhVPVZ,cplhhVZVZ,          & 
& cplHmcHmVP,cplHmcHmVPVZ,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,kont,PiZg_mz2)

Call Pi1LoopVP(MVZ2,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MVZ,MVZ2,            & 
& MHm,MHm2,MVWm,MVWm2,cplAhhhVP,cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,cplcFeFeVPR,         & 
...
& Y1e11input,Y1e12input,Y1e21input,Y1e22input,Y2e33input,Aa1input,Mu1input,              & 
& Mu2input,MuDashinput,Mubinput,Mu3input,v1input,v2input,v3input,Tpar,Spar,              & 
...
& cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFv1HmL(3,2),cplcFeFv1HmR(3,2),& 
& cplcFeFv1VWmL(3),cplcFeFv1VWmR(3),cplcFeFv2HmL(3,2),cplcFeFv2HmR(3,2),cplcFeFv2VWmL(3),& 
& cplcFeFv2VWmR(3),cplcFeFv3HmL(3,2),cplcFeFv3HmR(3,2),cplcFeFv3VWmL(3),cplcFeFv3VWmR(3),& 
...
& cplcFuFuVZR(3,3),cplcFv1FecHmL(3,2),cplcFv1FecHmR(3,2),cplcFv1FecVWmL(3),              & 
& cplcFv1FecVWmR(3),cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcFv1Fv1VZL,cplcFv1Fv1VZR,             & 
& cplcFv2FecHmL(3,2),cplcFv2FecHmR(3,2),cplcFv2FecVWmL(3),cplcFv2FecVWmR(3),             & 
& cplcFv2Fv2VPL,cplcFv2Fv2VPR,cplcFv2Fv2VZL,cplcFv2Fv2VZR,cplcFv3FecHmL(3,2),            & 
& cplcFv3FecHmR(3,2),cplcFv3FecVWmL(3),cplcFv3FecVWmR(3),cplcFv3Fv3VPL,cplcFv3Fv3VPR,    & 
& cplcFv3Fv3VZL,cplcFv3Fv3VZR,cplcgAgWmcVWm,cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWpgAcVWm,     & 
& cplcgWpgWpVP,cplcgWpgWpVZ,cplcgWpgZcVWm,cplcgZgWmcVWm,cplcHmVPVWm(2),cplcHmVWmVZ(2),   & 
...
& TSOddvvVRRSM(3,3,99,99),TSOddvvVLLSM(3,3,99,99),TSOddvvVRLSM(3,3,99,99),               & 
& TSOddvvVLRSM(3,3,99,99),TVOddvvVRRSM(3,3,99,99),TVOddvvVLLSM(3,3,99,99),               & 
& TVOddvvVRLSM(3,3,99,99),TVOddvvVLRSM(3,3,99,99),TSO4dSLLSM(3,3,3,3),TSO4dSRRSM(3,3,3,3),& 
& TSO4dSRLSM(3,3,3,3),TSO4dSLRSM(3,3,3,3),TSO4dVRRSM(3,3,3,3),TSO4dVLLSM(3,3,3,3),       & 
& TSO4dVRLSM(3,3,3,3),TSO4dVLRSM(3,3,3,3),TSO4dTLLSM(3,3,3,3),TSO4dTLRSM(3,3,3,3),       & 
& TSO4dTRLSM(3,3,3,3),TSO4dTRRSM(3,3,3,3),TVO4dSLLSM(3,3,3,3),TVO4dSRRSM(3,3,3,3),       & 
& TVO4dSRLSM(3,3,3,3),TVO4dSLRSM(3,3,3,3),TVO4dVRRSM(3,3,3,3),TVO4dVLLSM(3,3,3,3),       & 
& TVO4dVRLSM(3,3,3,3),TVO4dVLRSM(3,3,3,3),TVO4dTLLSM(3,3,3,3),TVO4dTLRSM(3,3,3,3),       & 
& TVO4dTRLSM(3,3,3,3),TVO4dTRRSM(3,3,3,3),TSOdulvSLLSM(3,3,99,3),TSOdulvSRRSM(3,3,99,3), & 
& TSOdulvSRLSM(3,3,99,3),TSOdulvSLRSM(3,3,99,3),TSOdulvVRRSM(3,3,99,3),TSOdulvVLLSM(3,3,99,3),& 
& TSOdulvVRLSM(3,3,99,3),TSOdulvVLRSM(3,3,99,3),TVOdulvSLLSM(3,3,99,3),TVOdulvSRRSM(3,3,99,3),& 
& TVOdulvSRLSM(3,3,99,3),TVOdulvSLRSM(3,3,99,3),TVOdulvVRRSM(3,3,99,3),TVOdulvVLLSM(3,3,99,3),& 
& TVOdulvVRLSM(3,3,99,3),TVOdulvVLRSM(3,3,99,3),BOddllSLLSM(3,3,3,3),BOddllSRRSM(3,3,3,3),& 
& BOddllSRLSM(3,3,3,3),BOddllSLRSM(3,3,3,3),BOddllVRRSM(3,3,3,3),BOddllVLLSM(3,3,3,3),   & 
& BOddllVRLSM(3,3,3,3),BOddllVLRSM(3,3,3,3),BOddllTLLSM(3,3,3,3),BOddllTLRSM(3,3,3,3),   & 
& BOddllTRLSM(3,3,3,3),BOddllTRRSM(3,3,3,3),PSOddllSLLSM(3,3,3,3),PSOddllSRRSM(3,3,3,3), & 
& PSOddllSRLSM(3,3,3,3),PSOddllSLRSM(3,3,3,3),PSOddllVRRSM(3,3,3,3),PSOddllVLLSM(3,3,3,3),& 
& PSOddllVRLSM(3,3,3,3),PSOddllVLRSM(3,3,3,3),PSOddllTLLSM(3,3,3,3),PSOddllTLRSM(3,3,3,3),& 
& PSOddllTRLSM(3,3,3,3),PSOddllTRRSM(3,3,3,3),PVOddllSLLSM(3,3,3,3),PVOddllSRRSM(3,3,3,3),& 
& PVOddllSRLSM(3,3,3,3),PVOddllSLRSM(3,3,3,3),PVOddllVRRSM(3,3,3,3),PVOddllVLLSM(3,3,3,3),& 
& PVOddllVRLSM(3,3,3,3),PVOddllVLRSM(3,3,3,3),PVOddllTLLSM(3,3,3,3),PVOddllTLRSM(3,3,3,3),& 
& PVOddllTRLSM(3,3,3,3),PVOddllTRRSM(3,3,3,3),BOddvvVRRSM(3,3,99,99),BOddvvVLLSM(3,3,99,99),& 
& BOddvvVRLSM(3,3,99,99),BOddvvVLRSM(3,3,99,99),PSOddvvVRRSM(3,3,99,99),PSOddvvVLLSM(3,3,99,99),& 
& PSOddvvVRLSM(3,3,99,99),PSOddvvVLRSM(3,3,99,99),PVOddvvVRRSM(3,3,99,99),               & 
& PVOddvvVLLSM(3,3,99,99),PVOddvvVRLSM(3,3,99,99),PVOddvvVLRSM(3,3,99,99),               & 
...
& TSOddvvVRR(3,3,99,99),TSOddvvVLL(3,3,99,99),TSOddvvVRL(3,3,99,99),TSOddvvVLR(3,3,99,99),& 
& TVOddvvVRR(3,3,99,99),TVOddvvVLL(3,3,99,99),TVOddvvVRL(3,3,99,99),TVOddvvVLR(3,3,99,99),& 
...
& TSOdulvSLL(3,3,99,3),TSOdulvSRR(3,3,99,3),TSOdulvSRL(3,3,99,3),TSOdulvSLR(3,3,99,3),   & 
& TSOdulvVRR(3,3,99,3),TSOdulvVLL(3,3,99,3),TSOdulvVRL(3,3,99,3),TSOdulvVLR(3,3,99,3),   & 
& TVOdulvSLL(3,3,99,3),TVOdulvSRR(3,3,99,3),TVOdulvSRL(3,3,99,3),TVOdulvSLR(3,3,99,3),   & 
& TVOdulvVRR(3,3,99,3),TVOdulvVLL(3,3,99,3),TVOdulvVRL(3,3,99,3),TVOdulvVLR(3,3,99,3),   & 
...
& BOddvvVRR(3,3,99,99),BOddvvVLL(3,3,99,99),BOddvvVRL(3,3,99,99),BOddvvVLR(3,3,99,99),   & 
& PSOddvvVRR(3,3,99,99),PSOddvvVLL(3,3,99,99),PSOddvvVRL(3,3,99,99),PSOddvvVLR(3,3,99,99),& 
& PVOddvvVRR(3,3,99,99),PVOddvvVLL(3,3,99,99),PVOddvvVRL(3,3,99,99),PVOddvvVLR(3,3,99,99),& 
...
& TSOddvvVRRcheck(3,3,99,99),TSOddvvVLLcheck(3,3,99,99),TSOddvvVRLcheck(3,3,99,99),      & 
& TSOddvvVLRcheck(3,3,99,99),TVOddvvVRRcheck(3,3,99,99),TVOddvvVLLcheck(3,3,99,99),      & 
& TVOddvvVRLcheck(3,3,99,99),TVOddvvVLRcheck(3,3,99,99),TSO4dSLLcheck(3,3,3,3),          & 
...
& TVO4dTLRcheck(3,3,3,3),TVO4dTRLcheck(3,3,3,3),TVO4dTRRcheck(3,3,3,3),TSOdulvSLLcheck(3,3,99,3),& 
& TSOdulvSRRcheck(3,3,99,3),TSOdulvSRLcheck(3,3,99,3),TSOdulvSLRcheck(3,3,99,3),         & 
& TSOdulvVRRcheck(3,3,99,3),TSOdulvVLLcheck(3,3,99,3),TSOdulvVRLcheck(3,3,99,3),         & 
& TSOdulvVLRcheck(3,3,99,3),TVOdulvSLLcheck(3,3,99,3),TVOdulvSRRcheck(3,3,99,3),         & 
& TVOdulvSRLcheck(3,3,99,3),TVOdulvSLRcheck(3,3,99,3),TVOdulvVRRcheck(3,3,99,3),         & 
& TVOdulvVLLcheck(3,3,99,3),TVOdulvVRLcheck(3,3,99,3),TVOdulvVLRcheck(3,3,99,3),         & 
...
& BOddvvVRRcheck(3,3,99,99),BOddvvVLLcheck(3,3,99,99),BOddvvVRLcheck(3,3,99,99),         & 
& BOddvvVLRcheck(3,3,99,99),PSOddvvVRRcheck(3,3,99,99),PSOddvvVLLcheck(3,3,99,99),       & 
& PSOddvvVRLcheck(3,3,99,99),PSOddvvVLRcheck(3,3,99,99),PVOddvvVRRcheck(3,3,99,99)

Complex(dp) :: PVOddvvVLLcheck(3,3,99,99),PVOddvvVRLcheck(3,3,99,99),PVOddvvVLRcheck(3,3,99,99),      & 
...
& OddvvVRRSM(3,3,99,99),OddvvVLLSM(3,3,99,99),OddvvVRLSM(3,3,99,99),OddvvVLRSM(3,3,99,99),& 
...
& OdulvSLLSM(3,3,99,3),OdulvSRRSM(3,3,99,3),OdulvSRLSM(3,3,99,3),OdulvSLRSM(3,3,99,3),   & 
& OdulvVRRSM(3,3,99,3),OdulvVLLSM(3,3,99,3),OdulvVRLSM(3,3,99,3),OdulvVLRSM(3,3,99,3),   & 
...
& OddvvVRR(3,3,99,99),OddvvVLL(3,3,99,99),OddvvVRL(3,3,99,99),OddvvVLR(3,3,99,99),       & 
...
& O4dTRL(3,3,3,3),O4dTRR(3,3,3,3),OdulvSLL(3,3,99,3),OdulvSRR(3,3,99,3),OdulvSRL(3,3,99,3),& 
& OdulvSLR(3,3,99,3),OdulvVRR(3,3,99,3),OdulvVLL(3,3,99,3),OdulvVRL(3,3,99,3),           & 
& OdulvVLR(3,3,99,3),CC8(3,3),CC8p(3,3),CC7(3,3),CC7p(3,3)
...
& Lam4input,Lam2input,Lam1Dashinput,Lam2Dashinput,Lam3Dashinput,Y1d11input,              & 
...
& Y1e12input,Y1e21input,Y1e22input,Y2e33input,Aa1input,Mu1input,Mu2input,MuDashinput,    & 
...
& MuDash,Mub,Mu3,v1,v2,v3,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
MHm(1)=MVWm
MHm2(1)=MVWm2
Call AllCouplings(Aa1,ZA,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,              & 
& v1,v2,v3,ZH,ZP,g1,g2,ZZ,g3,Y1d11,Y1d12,Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,            & 
& Y2d33,ZDL,ZDR,Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,ZEL,ZER,Y1u11,Y1u12,Y1u21,Y1u22,           & 
& Y2u33,ZUL,ZUR,cplAhAhAh,cplAhAhhh,cplAhhhhh,cplAhHmcHm,cplhhhhhh,cplhhHmcHm,           & 
& cplAhhhVP,cplAhhhVZ,cplAhHmcVWm,cplAhcHmVWm,cplhhHmcVWm,cplhhcHmVWm,cplHmcHmVP,        & 
& cplHmcHmVZ,cplhhVPVZ,cplhhcVWmVWm,cplhhVZVZ,cplHmcVWmVP,cplHmcVWmVZ,cplcHmVPVWm,       & 
...
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFeFehhL,cplcFeFehhR,cplcFv1FecHmL,cplcFv1FecHmR,         & 
& cplcFv2FecHmL,cplcFv2FecHmR,cplcFv3FecHmL,cplcFv3FecHmR,cplcFuFuhhL,cplcFuFuhhR,       & 
& cplcFdFuHmL,cplcFdFuHmR,cplcFeFv1HmL,cplcFeFv1HmR,cplcFeFv2HmL,cplcFeFv2HmR,           & 
& cplcFeFv3HmL,cplcFeFv3HmR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,             & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFeFeVPL,cplcFeFeVPR,           & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFv1FecVWmL,cplcFv1FecVWmR,cplcFv2FecVWmL,cplcFv2FecVWmR,   & 
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,         & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,         & 
& cplcFeFv1VWmL,cplcFeFv1VWmR,cplcFv1Fv1VZL,cplcFv1Fv1VZR,cplcFv2Fv2VPL,cplcFv2Fv2VPR,   & 
& cplcFeFv2VWmL,cplcFeFv2VWmR,cplcFv2Fv2VZL,cplcFv2Fv2VZR,cplcFv3Fv3VPL,cplcFv3Fv3VPR,   & 
& cplcFeFv3VWmL,cplcFeFv3VWmR,cplcFv3Fv3VZL,cplcFv3Fv3VZR)
...
& cplcFeFv1HmL,cplcFeFv1HmR,cplcFeFv1VWmL,cplcFeFv1VWmR,cplcFeFv2HmL,cplcFeFv2HmR,       & 
& cplcFeFv2VWmL,cplcFeFv2VWmR,cplcFeFv3HmL,cplcFeFv3HmR,cplcFeFv3VWmL,cplcFeFv3VWmR,     & 
...
& cplcFv1FecHmL,cplcFv1FecHmR,cplcFv1FecVWmL,cplcFv1FecVWmR,cplcFv2FecHmL,               & 
& cplcFv2FecHmR,cplcFv2FecVWmL,cplcFv2FecVWmR,cplcFv3FecHmL,cplcFv3FecHmR,               & 
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOddllSLL(gt1,gt2,gt3,gt4)              & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOddllSLL(gt1,gt2,gt3,gt4)              & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2d2nu(gt1,gt2,gt3,gt4,.False.,MFd,MFd2,MNeutrino,MNeutrino2,       & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2d2nu(gt1,gt2,gt3,gt4,.False.,MFd,MFd2,MNeutrino,MNeutrino2,       & 
...
& MNeutrino,MNeutrino2,TSOdulvSLL(gt1,gt2,gt3,gt4),TSOdulvSRR(gt1,gt2,gt3,gt4)           & 
...
& MNeutrino,MNeutrino2,TVOdulvSLL(gt1,gt2,gt3,gt4),TVOdulvSRR(gt1,gt2,gt3,gt4)           & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOddllSLL(gt1,gt2,gt3,gt4)               & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOddllSLL(gt1,gt2,gt3,gt4)              & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOddllSLL(gt1,gt2,gt3,gt4)              & 
...
Call CalculateBox2d2nu(gt1,gt2,gt3,gt4,.False.,MFd,MFd2,MNeutrino,MNeutrino2,         & 
...
If ((Abs(TSOddvvVRR(gt1,gt2,gt3,gt4)).lt.epsTree).and. & 
 ...
 & (Abs(TVOddvvVRL(gt1,gt2,gt3,gt4)).lt.epsTree).and. & 
 & (Abs(TVOddvvVLR(gt1,gt2,gt3,gt4)).lt.epsTree)) Then 
Call CalculatePengS2d2nu(gt1,gt2,gt3,gt4,.False.,MFd,MFd2,MNeutrino,MNeutrino2,       & 
...
If ((Abs(TSOddvvVRR(gt1,gt2,gt3,gt4)).lt.epsTree).and. & 
 ...
 & (Abs(TVOddvvVRL(gt1,gt2,gt3,gt4)).lt.epsTree).and. & 
 & (Abs(TVOddvvVLR(gt1,gt2,gt3,gt4)).lt.epsTree)) Then 
Call CalculatePengV2d2nu(gt1,gt2,gt3,gt4,.False.,MFd,MFd2,MNeutrino,MNeutrino2,       & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOddllSLLSM(gt1,gt2,gt3,gt4)            & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOddllSLLSM(gt1,gt2,gt3,gt4)            & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2d2nu(gt1,gt2,gt3,gt4,.true.,MFd,MFd2,MNeutrino,MNeutrino2,        & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2d2nu(gt1,gt2,gt3,gt4,.true.,MFd,MFd2,MNeutrino,MNeutrino2,        & 
...
& MNeutrino,MNeutrino2,TSOdulvSLLSM(gt1,gt2,gt3,gt4),TSOdulvSRRSM(gt1,gt2,gt3,gt4)       & 
...
& MNeutrino,MNeutrino2,TVOdulvSLLSM(gt1,gt2,gt3,gt4),TVOdulvSRRSM(gt1,gt2,gt3,gt4)       & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOddllSLLSM(gt1,gt2,gt3,gt4)             & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOddllSLLSM(gt1,gt2,gt3,gt4)            & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOddllSLLSM(gt1,gt2,gt3,gt4)            & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox2d2nu(gt1,gt2,gt3,gt4,.true.,MFd,MFd2,MNeutrino,MNeutrino2,          & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2d2nu(gt1,gt2,gt3,gt4,.true.,MFd,MFd2,MNeutrino,MNeutrino2,        & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2d2nu(gt1,gt2,gt3,gt4,.true.,MFd,MFd2,MNeutrino,MNeutrino2,        & 
...
& Lam2Dash,Lam3Dash,Y1d11,Y1d12,Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,               & 
& Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Aa1,Mu1,Mu2,               & 
& MuDash,Mub,Mu3,v1,v2,v3,CKM_MZ,sinW2_MZ,Alpha_MZ,AlphaS_MZ,.true.)
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOllddSLL(gt1,gt2,gt3,gt4)              & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOllddSLL(gt1,gt2,gt3,gt4)              & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOlluuSLL(gt1,gt2,gt3,gt4)              & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOlluuSLL(gt1,gt2,gt3,gt4)              & 
...
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhAh,cplAhAhhh,cplAhhhhh,cplAhhhVP,cplAhhhVZ,        & 
...
& cplcFeFv3VWmL,cplcFeFv3VWmR,cplcFv1FecHmL,cplcFv1FecHmR,cplcFv1FecVWmL,cplcFv1FecVWmR, & 
& cplcFv2FecHmL,cplcFv2FecHmR,cplcFv2FecVWmL,cplcFv2FecVWmR,cplcFv3FecHmL,               & 
& cplcFv3FecHmR,cplcFv3FecVWmL,cplcFv3FecVWmR,cplhhhhhh,cplhhVPVZ,cplhhVZVZ,             & 
...
& Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhAh,cplAhAhhh,cplAhhhhh,cplAhhhVP,             & 
& cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,     & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFv1HmL,cplcFeFv1HmR,cplcFeFv1VWmL,cplcFeFv1VWmR,         & 
& cplcFeFv2HmL,cplcFeFv2HmR,cplcFeFv2VWmL,cplcFeFv2VWmR,cplcFeFv3HmL,cplcFeFv3HmR,       & 
& cplcFeFv3VWmL,cplcFeFv3VWmR,cplcFv1FecHmL,cplcFv1FecHmR,cplcFv1FecVWmL,cplcFv1FecVWmR, & 
& cplcFv2FecHmL,cplcFv2FecHmR,cplcFv2FecVWmL,cplcFv2FecVWmR,cplcFv3FecHmL,               & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOllddSLL(gt1,gt2,gt3,gt4)               & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOllddSLL(gt1,gt2,gt3,gt4)              & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOllddSLL(gt1,gt2,gt3,gt4)              & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOlluuSLL(gt1,gt2,gt3,gt4)               & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOlluuSLL(gt1,gt2,gt3,gt4)              & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOlluuSLL(gt1,gt2,gt3,gt4)              & 
...
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhhhVP,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,    & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFv1HmL,cplcFeFv1HmR,             & 
& cplcFeFv1VWmL,cplcFeFv1VWmR,cplcFeFv2HmL,cplcFeFv2HmR,cplcFeFv2VWmL,cplcFeFv2VWmR,     & 
& cplcFeFv3HmL,cplcFeFv3HmR,cplcFeFv3VWmL,cplcFeFv3VWmR,cplcFv1FecHmL,cplcFv1FecHmR,     & 
& cplcFv1FecVWmL,cplcFv1FecVWmR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcFv2FecHmL,               & 
& cplcFv2FecHmR,cplcFv2FecVWmL,cplcFv2FecVWmR,cplcFv2Fv2VPL,cplcFv2Fv2VPR,               & 
& cplcFv3FecHmL,cplcFv3FecHmR,cplcFv3FecVWmL,cplcFv3FecVWmR,cplcFv3Fv3VPL,               & 
& cplcFv3Fv3VPR,cplcHmVPVWm,cplcVWmVPVWm,cplhhVPVZ,cplHmcHmVP,cplHmcVWmVP,               & 
...
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFv1HmL,cplcFeFv1HmR,             & 
& cplcFeFv1VWmL,cplcFeFv1VWmR,cplcFeFv2HmL,cplcFeFv2HmR,cplcFeFv2VWmL,cplcFeFv2VWmR,     & 
& cplcFeFv3HmL,cplcFeFv3HmR,cplcFeFv3VWmL,cplcFeFv3VWmR,cplcFv1FecHmL,cplcFv1FecHmR,     & 
& cplcFv1FecVWmL,cplcFv1FecVWmR,cplcF