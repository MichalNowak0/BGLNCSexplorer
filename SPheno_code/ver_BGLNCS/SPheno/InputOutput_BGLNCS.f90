...
! ------------------------------------------------------------------------------  
! File created at 0:10 on 25.6.2021   
! ----------------------------------------------------------------------  
...
Write(io_L,101) 31, Real(Y1n11input,dp) ,"# Y1n11input"
Write(io_L,101) 32, Real(Y1n12input,dp) ,"# Y1n12input"
Write(io_L,101) 33, Real(Y1n21input,dp) ,"# Y1n21input"
Write(io_L,101) 34, Real(Y1n22input,dp) ,"# Y1n22input"
Write(io_L,101) 35, Real(Y2n33input,dp) ,"# Y2n33input"
Write(io_L,101) 36, Real(BB11input,dp) ,"# BB11input"
Write(io_L,101) 37, Real(BB12input,dp) ,"# BB12input"
Write(io_L,101) 38, Real(BB21input,dp) ,"# BB21input"
Write(io_L,101) 39, Real(BB22input,dp) ,"# BB22input"
Write(io_L,101) 40, Real(C13input,dp) ,"# C13input"
Write(io_L,101) 41, Real(C23input,dp) ,"# C23input"
Write(io_L,101) 42, Real(C31input,dp) ,"# C31input"
Write(io_L,101) 43, Real(C32input,dp) ,"# C32input"
Write(io_L,101) 44, Real(v1input,dp) ,"# v1input"
Write(io_L,101) 45, Real(v2input,dp) ,"# v2input"
...
Write(io_L,101) 31, Aimag(Y1n11input) ,"# Y1n11input"
End if 
If (Abs(Aimag(Y1n12input)).gt.0._dp) Then 
Write(io_L,101) 32, Aimag(Y1n12input) ,"# Y1n12input"
End if 
If (Abs(Aimag(Y1n21input)).gt.0._dp) Then 
Write(io_L,101) 33, Aimag(Y1n21input) ,"# Y1n21input"
End if 
If (Abs(Aimag(Y1n22input)).gt.0._dp) Then 
Write(io_L,101) 34, Aimag(Y1n22input) ,"# Y1n22input"
End if 
If (Abs(Aimag(Y2n33input)).gt.0._dp) Then 
Write(io_L,101) 35, Aimag(Y2n33input) ,"# Y2n33input"
End if 
If (Abs(Aimag(BB11input)).gt.0._dp) Then 
Write(io_L,101) 36, Aimag(BB11input) ,"# BB11input"
End if 
If (Abs(Aimag(BB12input)).gt.0._dp) Then 
Write(io_L,101) 37, Aimag(BB12input) ,"# BB12input"
End if 
If (Abs(Aimag(BB21input)).gt.0._dp) Then 
Write(io_L,101) 38, Aimag(BB21input) ,"# BB21input"
End if 
If (Abs(Aimag(BB22input)).gt.0._dp) Then 
Write(io_L,101) 39, Aimag(BB22input) ,"# BB22input"
End if 
If (Abs(Aimag(C13input)).gt.0._dp) Then 
Write(io_L,101) 40, Aimag(C13input) ,"# C13input"
End if 
If (Abs(Aimag(C23input)).gt.0._dp) Then 
Write(io_L,101) 41, Aimag(C23input) ,"# C23input"
End if 
If (Abs(Aimag(C31input)).gt.0._dp) Then 
Write(io_L,101) 42, Aimag(C31input) ,"# C31input"
End if 
If (Abs(Aimag(C32input)).gt.0._dp) Then 
Write(io_L,101) 43, Aimag(C32input) ,"# C32input"
End if 
End if 
