...
& cplcFeFeVZR,cplcFeFv1HmL,cplcFeFv1HmR,cplcFeFv1VWmL,cplcFeFv1VWmR,cplcFeFv2HmL,        & 
& cplcFeFv2HmR,cplcFeFv2VWmL,cplcFeFv2VWmR,cplcFeFv3HmL,cplcFeFv3HmR,cplcFeFv3VWmL,      & 
& cplcFeFv3VWmR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuAhL,       & 
& cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,               & 
& cplcFuFuVZR,cplcFv1FecHmL,cplcFv1FecHmR,cplcFv1FecVWmL,cplcFv1FecVWmR,cplcFv2FecHmL,   & 
...
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOddllSLL,BOddllSRR,BOddllSRL,           & 
& BOddllSLR,BOddllVRR,BOddllVLL,BOddllVRL,BOddllVLR,BOddllTLL,BOddllTLR,BOddllTRL,       & 
& BOddllTRR)
...
& cplcFeFv3HmL(3,2),cplcFeFv3HmR(3,2),cplcFeFv3VWmL(3),cplcFeFv3VWmR(3),cplcFuFdcHmL(3,3,2),& 
& cplcFuFdcHmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuAhL(3,3,3),          & 
& cplcFuFuAhR(3,3,3),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVPL(3,3),             & 
& cplcFuFuVPR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFv1FecHmL(3,2),cplcFv1FecHmR(3,2),& 
& cplcFv1FecVWmL(3),cplcFv1FecVWmR(3),cplcFv2FecHmL(3,2),cplcFv2FecHmR(3,2),             & 
& cplcFv2FecVWmL(3),cplcFv2FecVWmR(3),cplcFv3FecHmL(3,2),cplcFv3FecHmR(3,2),             & 
& cplcFv3FecVWmL(3),cplcFv3FecVWmR(3),cplcHmVPVWm(2),cplcHmVWmVZ(2),cplcVWmVPVWm,        & 
& cplcVWmVWmVZ,cplhhcHmVWm(3,2),cplhhcVWmVWm(3),cplhhhhhh(3,3,3),cplhhHmcHm(3,2,2),      & 
& cplhhHmcVWm(3,2),cplhhVPVZ(3),cplhhVZVZ(3),cplHmcHmVP(2,2),cplHmcHmVZ(2,2),            & 
...
coup3L = cplcFeFv1HmL(gt4,i4)
coup3R = cplcFeFv1HmR(gt4,i4)
coup4L = cplcFv1FecHmL(gt3,i2)
coup4R = cplcFv1FecHmR(gt3,i2)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mS1 = MHm(i4)
mS12 = MHm2(i4)
...
coup3L = cplcFeFv1HmL(gt4,i4)
coup3R = cplcFeFv1HmR(gt4,i4)
coup4L = cplcFv1FecVWmL(gt3)
coup4R = cplcFv1FecVWmR(gt3)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mS1 = MHm(i4)
mS12 = MHm2(i4)
...
coup2L = cplcFdFuHmL(gt2,i1,i2)
coup2R = cplcFdFuHmR(gt2,i1,i2)
coup3L = cplcFeFv2HmL(gt4,i4)
coup3R = cplcFeFv2HmR(gt4,i4)
coup4L = cplcFv2FecHmL(gt3,i2)
coup4R = cplcFv2FecHmR(gt3,i2)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mS1 = MHm(i4)
mS12 = MHm2(i4)
...
coup3L = cplcFeFv2HmL(gt4,i4)
coup3R = cplcFeFv2HmR(gt4,i4)
coup4L = cplcFv2FecVWmL(gt3)
coup4R = cplcFv2FecVWmR(gt3)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mS1 = MHm(i4)
mS12 = MHm2(i4)
...
coup2L = cplcFdFuHmL(gt2,i1,i2)
coup2R = cplcFdFuHmR(gt2,i1,i2)
coup3L = cplcFeFv3HmL(gt4,i4)
coup3R = cplcFeFv3HmR(gt4,i4)
coup4L = cplcFv3FecHmL(gt3,i2)
coup4R = cplcFv3FecHmR(gt3,i2)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mS1 = MHm(i4)
mS12 = MHm2(i4)
...
coup3L = cplcFeFv3HmL(gt4,i4)
coup3R = cplcFeFv3HmR(gt4,i4)
coup4L = cplcFv3FecVWmL(gt3)
coup4R = cplcFv3FecVWmR(gt3)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mS1 = MHm(i4)
mS12 = MHm2(i4)
...
coup2L = cplcFdFuHmL(gt2,i1,i2)
coup2R = cplcFdFuHmR(gt2,i1,i2)
coup3L = cplcFeFv1VWmL(gt4)
coup3R = cplcFeFv1VWmR(gt4)
coup4L = cplcFv1FecHmL(gt3,i2)
coup4R = cplcFv1FecHmR(gt3,i2)
mF1 = MFu(i1)
mF12 = MFu2(i1)
...
coup2L = cplcFdFuHmL(gt2,i1,i2)
coup2R = cplcFdFuHmR(gt2,i1,i2)
coup3L = cplcFeFv2VWmL(gt4)
coup3R = cplcFeFv2VWmR(gt4)
coup4L = cplcFv2FecHmL(gt3,i2)
coup4R = cplcFv2FecHmR(gt3,i2)
mF1 = MFu(i1)
mF12 = MFu2(i1)
...
coup2L = cplcFdFuHmL(gt2,i1,i2)
coup2R = cplcFdFuHmR(gt2,i1,i2)
coup3L = cplcFeFv3VWmL(gt4)
coup3R = cplcFeFv3VWmR(gt4)
coup4L = cplcFv3FecHmL(gt3,i2)
coup4R = cplcFv3FecHmR(gt3,i2)
mF1 = MFu(i1)
mF12 = MFu2(i1)
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOddllSLL,PSOddllSRR,PSOddllSRL,        & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOddllSLL,PVOddllSRR,PVOddllSRL,        & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOddllSLL,TSOddllSRR,TSOddllSRL,        & 
...
& cplcFv3FecVWmL,cplcFv3FecVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,       & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOddllSLL,TVOddllSRR,TVOddllSRL,        & 
...
Subroutine CalculateBox2d2nu(gt1,gt2,gt3,gt4,OnlySM,MFd,MFd2,MNeutrino,               & 
& MNeutrino2,BOddvvVRR,BOddvvVLL,BOddvvVRL,BOddvvVLR)
...
Complex(dp),Intent(in) :: MNeutrino,MNeutrino2
...
MassEx2=MFd(gt2)  
MassEx22=MFd2(gt2) 
MassEx3=MNeutrino(gt3)  
MassEx32=MNeutrino2(gt3) 
MassEx4=MNeutrino(gt4)  
MassEx42=MNeutrino2(gt4) 
! ------------------------------ 
 ! Amplitudes for external states 
...
Subroutine CalculatePengS2d2nu(gt1,gt2,gt3,gt4,OnlySM,MFd,MFd2,MNeutrino,             & 
& MNeutrino2,PSOddvvVRR,PSOddvvVLL,PSOddvvVRL,PSOddvvVLR)
...
Subroutine CalculatePengV2d2nu(gt1,gt2,gt3,gt4,OnlySM,MFd,MFd2,MNeutrino,             & 
& MNeutrino2,PVOddvvVRR,PVOddvvVLL,PVOddvvVRL,PVOddvvVLR)
...
Subroutine CalculateTreeS2d2nu(gt1,gt2,gt3,gt4,OnlySM,MFd,MFd2,MNeutrino,             & 
& MNeutrino2,TSOddvvVRR,TSOddvvVLL,TSOddvvVRL,TSOddvvVLR)
...
Subroutine CalculateTreeV2d2nu(gt1,gt2,gt3,gt4,OnlySM,MFd,MFd2,MNeutrino,             & 
& MNeutrino2,TVOddvvVRR,TVOddvvVLL,TVOddvvVRL,TVOddvvVLR)
...
& MFu,MFu2,MNeutrino,MNeutrino2,TSOdulvSLL,TSOdulvSRR,TSOdulvSRL,TSOdulvSLR,             & 
...
& MFu,MFu2,MNeutrino,MNeutrino2,TVOdulvSLL,TVOdulvSRR,TVOdulvSRL,TVOdulvSLR,             & 
...
End Function C1C2 
End Module FlavorKit_QFV_BGLCS 
