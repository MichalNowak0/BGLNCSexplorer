...
& PDGgZ,PDGgG,PDGFd(3),PDGFu(3),PDGFe(3),PDGFv1,PDGFv2,PDGFv3
...
Character(len=30) :: NameParticleFv1
Character(len=30) :: NameParticleFv2
Character(len=30) :: NameParticleFv3
...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - BGLCS Spectrum + Decays + Flavour Observables"
...
Write(io_L,101) 12, Real(Y1d11input,dp) ,"# Y1d11input"
Write(io_L,101) 13, Real(Y1d12input,dp) ,"# Y1d12input"
Write(io_L,101) 14, Real(Y1d13input,dp) ,"# Y1d13input"
Write(io_L,101) 15, Real(Y1d21input,dp) ,"# Y1d21input"
Write(io_L,101) 16, Real(Y1d22input,dp) ,"# Y1d22input"
Write(io_L,101) 17, Real(Y1d23input,dp) ,"# Y1d23input"
Write(io_L,101) 18, Real(Y2d31input,dp) ,"# Y2d31input"
Write(io_L,101) 19, Real(Y2d32input,dp) ,"# Y2d32input"
Write(io_L,101) 20, Real(Y2d33input,dp) ,"# Y2d33input"
Write(io_L,101) 21, Real(Y1u11input,dp) ,"# Y1u11input"
Write(io_L,101) 22, Real(Y1u12input,dp) ,"# Y1u12input"
Write(io_L,101) 23, Real(Y1u21input,dp) ,"# Y1u21input"
Write(io_L,101) 24, Real(Y1u22input,dp) ,"# Y1u22input"
Write(io_L,101) 25, Real(Y2u33input,dp) ,"# Y2u33input"
Write(io_L,101) 26, Real(Y1e11input,dp) ,"# Y1e11input"
Write(io_L,101) 27, Real(Y1e12input,dp) ,"# Y1e12input"
Write(io_L,101) 28, Real(Y1e21input,dp) ,"# Y1e21input"
Write(io_L,101) 29, Real(Y1e22input,dp) ,"# Y1e22input"
Write(io_L,101) 30, Real(Y2e33input,dp) ,"# Y2e33input"
Write(io_L,101) 31, Real(v1input,dp) ,"# v1input"
Write(io_L,101) 32, Real(v2input,dp) ,"# v2input"
...
Write(io_L,101) 12, Aimag(Y1d11input) ,"# Y1d11input"
End if 
If (Abs(Aimag(Y1d12input)).gt.0._dp) Then 
Write(io_L,101) 13, Aimag(Y1d12input) ,"# Y1d12input"
End if 
If (Abs(Aimag(Y1d13input)).gt.0._dp) Then 
Write(io_L,101) 14, Aimag(Y1d13input) ,"# Y1d13input"
End if 
If (Abs(Aimag(Y1d21input)).gt.0._dp) Then 
Write(io_L,101) 15, Aimag(Y1d21input) ,"# Y1d21input"
End if 
If (Abs(Aimag(Y1d22input)).gt.0._dp) Then 
Write(io_L,101) 16, Aimag(Y1d22input) ,"# Y1d22input"
End if 
If (Abs(Aimag(Y1d23input)).gt.0._dp) Then 
Write(io_L,101) 17, Aimag(Y1d23input) ,"# Y1d23input"
End if 
If (Abs(Aimag(Y2d31input)).gt.0._dp) Then 
Write(io_L,101) 18, Aimag(Y2d31input) ,"# Y2d31input"
End if 
If (Abs(Aimag(Y2d32input)).gt.0._dp) Then 
Write(io_L,101) 19, Aimag(Y2d32input) ,"# Y2d32input"
End if 
If (Abs(Aimag(Y2d33input)).gt.0._dp) Then 
Write(io_L,101) 20, Aimag(Y2d33input) ,"# Y2d33input"
End if 
If (Abs(Aimag(Y1u11input)).gt.0._dp) Then 
Write(io_L,101) 21, Aimag(Y1u11input) ,"# Y1u11input"
End if 
If (Abs(Aimag(Y1u12input)).gt.0._dp) Then 
Write(io_L,101) 22, Aimag(Y1u12input) ,"# Y1u12input"
End if 
If (Abs(Aimag(Y1u21input)).gt.0._dp) Then 
Write(io_L,101) 23, Aimag(Y1u21input) ,"# Y1u21input"
End if 
If (Abs(Aimag(Y1u22input)).gt.0._dp) Then 
Write(io_L,101) 24, Aimag(Y1u22input) ,"# Y1u22input"
End if 
If (Abs(Aimag(Y2u33input)).gt.0._dp) Then 
Write(io_L,101) 25, Aimag(Y2u33input) ,"# Y2u33input"
End if 
If (Abs(Aimag(Y1e11input)).gt.0._dp) Then 
Write(io_L,101) 26, Aimag(Y1e11input) ,"# Y1e11input"
End if 
If (Abs(Aimag(Y1e12input)).gt.0._dp) Then 
Write(io_L,101) 27, Aimag(Y1e12input) ,"# Y1e12input"
End if 
If (Abs(Aimag(Y1e21input)).gt.0._dp) Then 
Write(io_L,101) 28, Aimag(Y1e21input) ,"# Y1e21input"
End if 
If (Abs(Aimag(Y1e22input)).gt.0._dp) Then 
Write(io_L,101) 29, Aimag(Y1e22input) ,"# Y1e22input"
End if 
If (Abs(Aimag(Y2e33input)).gt.0._dp) Then 
Write(io_L,101) 30, Aimag(Y2e33input) ,"# Y2e33input"
End if 
End if 
...
If (OutputForMG)  Write(io_L,102) 12,0._dp,"# Fv1" 
If (OutputForMG)  Write(io_L,102) 14,0._dp,"# Fv2" 
If (OutputForMG)  Write(io_L,102) 16,0._dp,"# Fv3" 
...
icount = icount +1 
  ...
  Do gt2=2, 2
If (BRFe(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv1 
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFv1)//" "//Trim(NameParticleHm(gt2))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = PDGVWm 
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFv1)//" "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
  Do gt2=2, 2
If (BRFe(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv2 
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFv2)//" "//Trim(NameParticleHm(gt2))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = PDGVWm 
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFv2)//" "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
  Do gt2=2, 2
If (BRFe(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv3 
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFv3)//" "//Trim(NameParticleHm(gt2))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = PDGVWm 
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFv3)//" "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFv1)//" "//Trim(NameParticleHm(gt2))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = PDGVWm 
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFv1)//" "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
  Do gt2=2, 2
If (BRFe(2,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFv2)//" "//Trim(NameParticleHm(gt2))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = PDGVWm 
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFv2)//" "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
  Do gt2=2, 2
If (BRFe(2,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFv3)//" "//Trim(NameParticleHm(gt2))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = PDGVWm 
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFv3)//" "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFv1)//" "//Trim(NameParticleHm(gt2))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = PDGVWm 
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFv1)//" "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
  Do gt2=2, 2
If (BRFe(3,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFv2)//" "//Trim(NameParticleHm(gt2))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = PDGVWm 
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFv2)//" "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
  Do gt2=2, 2
If (BRFe(3,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFv3)//" "//Trim(NameParticleHm(gt2))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = PDGVWm 
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFv3)//" "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = -PDGFe(gt2) 
Write(io_L,201) BRHm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHm(2))//"^* -> "//Trim(NameParticleFv1)//" "//Trim(NameParticleFe(gt2))//"^* "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = -PDGFe(gt2) 
Write(io_L,201) BRHm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHm(2))//"^* -> "//Trim(NameParticleFv2)//" "//Trim(NameParticleFe(gt2))//"^* "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = -PDGFe(gt2) 
Write(io_L,201) BRHm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHm(2))//"^* -> "//Trim(NameParticleFv3)//" "//Trim(NameParticleFe(gt2))//"^* "//")"
End if 
icount = icount +1 
End Do 
...
If (BRVZ(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFv1 
CurrentPDG2(2) = PDGFv1 
Write(io_L,201) BRVZ(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticleFv1)//"^* "//Trim(NameParticleFv1)//" "//")"
End if 
icount = icount +1 
If (BRVZ(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFv2 
CurrentPDG2(2) = PDGFv2 
Write(io_L,201) BRVZ(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticleFv2)//"^* "//Trim(NameParticleFv2)//" "//")"
End if 
icount = icount +1 
If (BRVZ(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFv3 
CurrentPDG2(2) = PDGFv3 
Write(io_L,201) BRVZ(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticleFv3)//"^* "//Trim(NameParticleFv3)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 3
If (BRVZ(1,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = -PDGFe(gt2) 
Write(io_L,201) BRVWm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWm)//"^* -> "//Trim(NameParticleFv1)//" "//Trim(NameParticleFe(gt2))//"^* "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = -PDGFe(gt2) 
Write(io_L,201) BRVWm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWm)//"^* -> "//Trim(NameParticleFv2)//" "//Trim(NameParticleFe(gt2))//"^* "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = -PDGFe(gt2) 
Write(io_L,201) BRVWm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWm)//"^* -> "//Trim(NameParticleFv3)//" "//Trim(NameParticleFe(gt2))//"^* "//")"
End if 
icount = icount +1 
End Do 
...
Write(io_L,200) INT(Abs(PDGFv1)),0._dp, "Fv1_1" 
Write(io_L,200) INT(Abs(PDGFv2)),0._dp, "Fv2_1" 
Write(io_L,200) INT(Abs(PDGFv3)),0._dp, "Fv3_1" 
End if 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.BGLCS",status="unknown")
...
Subroutine WriteWCXF 
   Open(123,file="WC.BGLCS_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.BGLCS_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
