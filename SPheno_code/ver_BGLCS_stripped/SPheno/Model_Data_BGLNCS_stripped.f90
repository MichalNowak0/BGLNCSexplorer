...
Module Model_Data_BGLNCS_stripped 
...
Real(dp) :: MuDash1L 
Real(dp) :: MuDash2L 
Real(dp) :: mass_uncertainty_Q(17), mass_uncertainty_Yt(17), g_SM_save(62) 
...
Complex(dp) :: Lam1IN,Lam3IN,Lam4IN,Lam2IN,Lam1DashIN,Lam2DashIN,Lam3DashIN,Y1dIN(3,3),              & 
& Y2dIN(3,3),Y1uIN(3,3),Y2uIN(3,3),Y1eIN(3,3),Y2eIN(3,3),Aa1IN,MubIN,Mu3IN

Real(dp) :: g1MZ,g2MZ,g3MZ,Mu1MZ,Mu2MZ,MuDashMZ

Complex(dp) :: Lam1MZ,Lam3MZ,Lam4MZ,Lam2MZ,Lam1DashMZ,Lam2DashMZ,Lam3DashMZ,Y1dMZ(3,3),              & 
& Y2dMZ(3,3),Y1uMZ(3,3),Y2uMZ(3,3),Y1eMZ(3,3),Y2eMZ(3,3),Aa1MZ,MubMZ,Mu3MZ

Real(dp) :: g1GUT,g2GUT,g3GUT,Mu1GUT,Mu2GUT,MuDashGUT

Complex(dp) :: Lam1GUT,Lam3GUT,Lam4GUT,Lam2GUT,Lam1DashGUT,Lam2DashGUT,Lam3DashGUT,Y1dGUT(3,3),      & 
& Y2dGUT(3,3),Y1uGUT(3,3),Y2uGUT(3,3),Y1eGUT(3,3),Y2eGUT(3,3),Aa1GUT,MubGUT,Mu3GUT
...
Real(dp) :: gPFu(3,159),gTFu(3),BRFu(3,159),gPFe(3,159),gTFe(3),BRFe(3,159),gPFd(3,159),          & 
...
Real(dp) :: gP1LFu(3,24),gT1LFu(3),BR1LFu(3,24),gP1LFe(3,24),gT1LFe(3),BR1LFe(3,24),              & 
& gP1LFd(3,24),gT1LFd(3),BR1LFd(3,24),gP1Lhh(3,52),gT1Lhh(3),BR1Lhh(3,52),               & 
& gP1LAh(3,49),gT1LAh(3),BR1LAh(3,49),gP1LHm(2,30),gT1LHm(2),BR1LHm(2,30),               & 
& gP1LVZ(1,48),gT1LVZ,BR1LVZ(1,48),gP1LVWm(1,28),gT1LVWm,BR1LVWm(1,28)
...
Real(dp) :: v2inputQ
Real(dp) :: v3inputQ
Real(dp) :: gForTadpoles(137)
Complex(dp) :: tForTadpoles(3)
Real(dp) :: g1_saveEP 
Real(dp) :: g2_saveEP 
Complex(dp) :: Y1d_saveEP(3,3) 
Complex(dp) :: Y2d_saveEP(3,3) 
Complex(dp) :: Y1u_saveEP(3,3) 
Complex(dp) :: Y2u_saveEP(3,3) 
Complex(dp) :: Y1e_saveEP(3,3) 
Complex(dp) :: Y2e_saveEP(3,3) 
...
Logical, save :: InputValueforY1d =.False. 
Logical, save :: InputValueforY2d =.False. 
Logical, save :: InputValueforY1u =.False. 
Logical, save :: InputValueforY2u =.False. 
Logical, save :: InputValueforY1e =.False. 
Logical, save :: InputValueforY2e =.False. 
...
& v3,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,Y1d,Y2d,Y1u,Y2u,            & 
& Y1e,Y2e,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,MZsuffix)
...
End Module Model_Data_BGLNCS_stripped