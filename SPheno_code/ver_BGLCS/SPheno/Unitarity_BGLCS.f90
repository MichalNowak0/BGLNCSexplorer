...
& Y2u33input,Y1e11input,Y1e12input,Y1e21input,Y1e22input,Y2e33input,Aa1input,            & 
& Mu1input,Mu2input,MuDashinput,Mubinput,Mu3input,delta0,kont)
