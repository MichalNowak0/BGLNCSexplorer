...
& C32,BB11,BB12,BB21,BB22,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,.True.,kont)
...
& Y1n22input,Y2n33input,C13input,C23input,C31input,C32input,BB11input,BB12input,         & 
& BB21input,BB22input,Aa1input,Mu1input,Mu2input,MuDashinput,Mubinput,Mu3input,          & 
& v1input,v2input,v3input,cplFvFvAhL,cplFvFvAhR,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,    & 
...
& cplcFuFuhhL,cplcFuFuhhR,cplFvFvhhL,cplFvFvhhR,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,        & 
...
& cplFvFvAhL,cplFvFvAhR,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,deltaM)
...
& cplFvFecHmL,cplFvFecHmR,cplhhHmcHm,cplhhcHmVWm,cplHmcHmVZ,cplcHmVWmVZ,deltaM)
...
& cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,        & 
& cplcVWmVWmVZ,deltaM)
...
& Y1n22input,Y2n33input,C13input,C23input,C31input,C32input,BB11input,BB12input,         & 
& BB21input,BB22input,Aa1input,Mu1input,Mu2input,MuDashinput,Mubinput,Mu3input,          & 
& v1input,v2input,v3input,cplAhHmcVWm,cplcFuFdcVWmL,cplcFuFdcVWmR,cplFvFecVWmL,          & 
& cplFvFecVWmR,cplhhHmcVWm,cplhhcVWmVWm,cplHmcVWmVZ,cplcVWmVWmVZ,deltaM)
...
& cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFuAhL,cplcFuFuAhR,             & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplFvFecHmL,cplFvFecHmR,               & 
...
& cplcFuFuVZL,cplcFuFuVZR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,        & 
& cplFvFvVZR,deltaM)
