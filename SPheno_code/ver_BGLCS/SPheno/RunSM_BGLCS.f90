...
& MuDash,Mub,Mu3,v1,v2,v3,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
scale_save = Qin 
Call ParametersToG67(g1input,g2input,g3input,Lam1input,Lam3input,Lam4input,           & 
...
& Y1e21input,Y1e22input,Y2e33input,Aa1input,Mu1input,Mu2input,MuDashinput,               & 
& Mubinput,Mu3input,v1input,v2input,v3input,g1D)

Call GToParameters67(g1D,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,              & 
