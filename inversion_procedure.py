...
def initialize_symb_expr():
    ...
    fast_Aa1 = sp.lambdify([gamma1, mA1, mA2, v], A_Aa1, "numpy")
    fast_Mub = sp.lambdify([Aa1, mA1, mA2, v_1, v_2, v_3, gamma1], A_Mub, "numpy")
    fast_Mu3 = sp.lambdify([Aa1, mA1, mA2, v, v_1, v_2, v_3, gamma1], A_Mu3, "numpy")
    fast_Lambda1  = sp.lambdify([Aa1, mh, mH, mS, v, v_1, v_2, v_3, Mu3, a1, a2, a3], A_Lambda1, "numpy")
    fast_Lambda2  = sp.lambdify([Aa1, mh, mH, mS, v, v_1, v_2, v_3, Mu3, a1, a2, a3, Lambda1], A_Lambda2, "numpy")
    fast_Lambda4  = sp.lambdify([Aa1, mHp, v, v_1, v_2, v_3, Mu3], A_Lambda4, "numpy")
    fast_Lambda3  = sp.lambdify([Aa1, mh, mH, mS, v, v_1, v_2, v_3, Mu3, a1, a2, a3, Lambda1, Lambda2, Lambda4], A_Lambda3, "numpy")
    fast_Lambda1Dash  = sp.lambdify([Aa1, mh, mH, mS, v, v_1, v_2, v_3, Mu3, a1, a2, a3], A_Lambda1Dash, "numpy")
    fast_Lambda2Dash  = sp.lambdify([Aa1, mh, mH, mS, v, v_1, v_2, v_3, a1, a2, a3], A_Lambda2Dash, "numpy")
    fast_Lambda3Dash  = sp.lambdify([Aa1, mh, mH, mS, v, v_1, v_2, v_3, a1, a2, a3, Lambda2Dash], A_Lambda3Dash, "numpy")
    fast_Mu1  = sp.lambdify([Aa1, Aa2, Aa3, Aa4, v_1, v_2, v_3, Mu3, Lambda1, Lambda3, Lambda4, Lambda2Dash], A_Mu1, "numpy")
    fast_Mu2  = sp.lambdify([Aa1, Aa2, Aa3, Aa4, v_1, v_2, v_3, Mu3, Lambda2, Lambda3, Lambda4, Lambda3Dash], A_Mu2, "numpy")
    fast_MuDash  = sp.lambdify([Aa1, Aa2, Aa3, Aa4, v_1, v_2, v_3, Mub, Lambda1Dash, Lambda2Dash, Lambda3Dash], A_MuDash, "numpy")
     
    return fast_Aa1, fast_Mub, fast_Mu3, fast_Lambda1, fast_Lambda2, fast_Lambda4, fast_Lambda3, \
        fast_Lambda1Dash, fast_Lambda2Dash, fast_Lambda3Dash, fast_Mu1, fast_Mu2, fast_MuDash
        
def scalar_inversion(num_gamma1, Aa1, num_Aa2, num_Aa3, num_Aa4, m_hh1, m_hh2, m_hh3, m_ah, m_pgs,
                     m_chh, num_v, num_v_1, num_v_2, num_v_3, num_a1, num_a2, num_a3, fast_Aa1, fast_Mub,
                     fast_Mu3, fast_Lambda1, fast_Lambda2, fast_Lambda4, fast_Lambda3,
                     fast_Lambda1Dash, fast_Lambda2Dash, fast_Lambda3Dash, fast_Mu1, fast_Mu2, fast_MuDash):
    # Using the analytical inversion equations to express parameters in terms of other parameters & observables:
    num_Aa1 = fast_Aa1(num_gamma1, m_ah, m_pgs, num_v)
    num_Mub = fast_Mub(num_Aa1, m_ah, m_pgs, num_v_1, num_v_2, num_v_3, num_gamma1)
    num_Mu3 = fast_Mu3(num_Aa1, m_ah, m_pgs, num_v, num_v_1, num_v_2, num_v_3, num_gamma1)
    num_Lambda1 = fast_Lambda1(num_Aa1, m_hh1, m_hh2, m_hh3, num_v, num_v_1, num_v_2, num_v_3,
                               num_Mu3, num_a1, num_a2, num_a3)
    num_Lambda2 = fast_Lambda2(num_Aa1, m_hh1, m_hh2, m_hh3, num_v, num_v_1, num_v_2, num_v_3,
                               num_Mu3, num_a1, num_a2, num_a3, num_Lambda1)
    num_Lambda4 = fast_Lambda4(num_Aa1, m_chh, num_v, num_v_1, num_v_2, num_v_3, num_Mu3)
    num_Lambda3 = fast_Lambda3(num_Aa1, m_hh1, m_hh2, m_hh3, num_v, num_v_1, num_v_2, num_v_3, num_Mu3, num_a1, num_a2, num_a3, num_Lambda1, num_Lambda2, num_Lambda4)
    num_Lambda1Dash = fast_Lambda1Dash(num_Aa1, m_hh1, m_hh2, m_hh3, num_v, num_v_1, num_v_2, num_v_3, num_Mu3, num_a1, num_a2, num_a3)
    num_Lambda2Dash = fast_Lambda2Dash(num_Aa1, m_hh1, m_hh2, m_hh3, num_v, num_v_1, num_v_2, num_v_3, num_a1, num_a2, num_a3)
    num_Lambda3Dash = fast_Lambda3Dash(num_Aa1, m_hh1, m_hh2, m_hh3, num_v, num_v_1, num_v_2, num_v_3, num_a1, num_a2, num_a3, num_Lambda2Dash)
    """
    print(num_gamma1, "\n ", num_Mub, "\n ", num_Mu3, "\n ", num_Lambda1, "\n ", num_Lambda2, "\n ",
          num_Lambda3, "\n ", num_Lambda4, "\n ", num_Lambda1Dash, "\n ", num_Lambda2Dash, "\n ", num_Lambda3Dash)
    """
    # Tadpole equations:
    num_Mu1 = fast_Mu1(num_Aa1, num_Aa2, num_Aa3, num_Aa4, num_v_1, num_v_2, num_v_3, num_Mu3, num_Lambda1, num_Lambda3, num_Lambda4, num_Lambda2Dash)
    num_Mu2 = fast_Mu2(num_Aa1, num_Aa2, num_Aa3, num_Aa4, num_v_1, num_v_2, num_v_3, num_Mu3, num_Lambda2, num_Lambda3, num_Lambda4, num_Lambda3Dash)
    num_MuDash = fast_MuDash(num_Aa1, num_Aa2, num_Aa3, num_Aa4, num_v_1, num_v_2, num_v_3, num_Mub, num_Lambda1Dash, num_Lambda2Dash, num_Lambda3Dash)
...
def Quark_Yukawa_Inversion(num_v, num_Beta, num_v_1, num_v_2, num_v_3):
    """Yukawas calculation
    -------------------------------------------------------------------------------
    v_sm = 246
...
def Lepton_Yukawa_Inversion(num_v, num_v_1, num_v_2, num_v_3):
