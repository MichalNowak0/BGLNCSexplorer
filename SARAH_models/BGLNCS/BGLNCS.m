...
(* ::Input::Initialization:: *)
(*Lagrangian pieces*)
LagFerD = -(Y1d11 conj[H1].d1.q1 +Y1d12 conj[H1].q1.d2+Y1d13 conj[H1].q1.d3+Y1d21 conj[H1].q2.d1 \
...
LagMajorana =1/2 BB11 conj[S].v1R.v1R+1/2 BB12 conj[S].v1R.v2R+1/2 BB21 conj[S].v2R.v1R+1/2 BB22 conj[S].v2R.v2R+\
...
LagSymBrTerms=-(Mu3 conj[H2].H1+1/2 Mub S.S+Aa1 conj[H1].H2.S);
