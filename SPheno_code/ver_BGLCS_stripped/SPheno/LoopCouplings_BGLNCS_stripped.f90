...
Module LoopCouplings_BGLNCS_stripped 
...
Subroutine DeltaVB(sinW2,sinW2_dr,rho,MAh,MFe,Mhh,MHm,MVWm,g2,ZER,v1,v2,              & 
& ZEL,Y1e,Y2e,ZA,ZH,ZP,res)

Implicit None 
Real(dp),Intent(in) :: MAh(3),MFe(3),Mhh(3),MHm(2),MVWm,g2,v1,v2,ZA(3,3),ZH(3,3)

Complex(dp),Intent(in) :: ZER(3,3),ZEL(3,3),Y1e(3,3),Y2e(3,3),ZP(2,2)

Real(dp) :: MAh2(3),MFe2(3),Mhh2(3),MHm2(2),MVWm2

Complex(dp) :: cplAhcHmVWm(3,2),cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),            & 
& cplcFeFehhR(3,3,3),cplcFeFvHmL(3,3,2),cplcFeFvHmR(3,3,2),cplcFeFvVWmL(3,3),            & 
& cplcFeFvVWmR(3,3),cplcFvFecHmL(3,3,2),cplcFvFecHmR(3,3,2),cplhhcHmVWm(3,2),            & 
& cplhhcVWmVWm(3)
...
End Module LoopCouplings_BGLNCS_stripped 
