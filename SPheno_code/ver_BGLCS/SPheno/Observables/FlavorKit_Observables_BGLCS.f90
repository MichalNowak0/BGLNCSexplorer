...
Module FlavorKit_Observables_BGLCS 
Use Control 
Use Settings 
Use Couplings_BGLCS 
...
Implicit None 
Complex(dp) :: OddvvVRR(3,3,99,99),OddvvVLL(3,3,99,99),OddvvVRL(3,3,99,99),OddvvVLR(3,3,99,99),      & 
...
Implicit None 
Complex(dp) :: OdulvSLL(3,3,99,3),OdulvSRR(3,3,99,3),OdulvSRL(3,3,99,3),OdulvSLR(3,3,99,3),          & 
& OdulvVRR(3,3,99,3),OdulvVLL(3,3,99,3),OdulvVRL(3,3,99,3),OdulvVLR(3,3,99,3),           & 
...
End Function C1C2 
End Module FlavorKit_Observables_BGLCS 
