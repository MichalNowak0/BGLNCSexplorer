...
Module InputOutput_BGLNCS_stripped 
...
Do 
 ...
 End If 
   ...
   Else If (read_line(7:11).Eq."Y1DIN") Then 
InputValueforY1d= .True. 
    Call ReadMatrixC(99,3,3,Y1dIN,0, "Y1dIN",kont)

 
   Else If (read_line(7:13).Eq."IMY1DIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMY1d") 
       Cycle 
     End If 
    Call ReadMatrixC(99,3,3,Y1dIN,1, "Y1dIN",kont)

 
   Else If (read_line(7:11).Eq."Y2DIN") Then 
InputValueforY2d= .True. 
    Call ReadMatrixC(99,3,3,Y2dIN,0, "Y2dIN",kont)

 
   Else If (read_line(7:13).Eq."IMY2DIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMY2d") 
       Cycle 
     End If 
    Call ReadMatrixC(99,3,3,Y2dIN,1, "Y2dIN",kont)

 
   Else If (read_line(7:11).Eq."Y1UIN") Then 
InputValueforY1u= .True. 
    Call ReadMatrixC(99,3,3,Y1uIN,0, "Y1uIN",kont)

 
   Else If (read_line(7:13).Eq."IMY1UIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMY1u") 
       Cycle 
     End If 
    Call ReadMatrixC(99,3,3,Y1uIN,1, "Y1uIN",kont)

 
   Else If (read_line(7:11).Eq."Y2UIN") Then 
InputValueforY2u= .True. 
    Call ReadMatrixC(99,3,3,Y2uIN,0, "Y2uIN",kont)

 
   Else If (read_line(7:13).Eq."IMY2UIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMY2u") 
       Cycle 
     End If 
    Call ReadMatrixC(99,3,3,Y2uIN,1, "Y2uIN",kont)

 
   Else If (read_line(7:11).Eq."Y1EIN") Then 
InputValueforY1e= .True. 
    Call ReadMatrixC(99,3,3,Y1eIN,0, "Y1eIN",kont)

 
   Else If (read_line(7:13).Eq."IMY1EIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMY1e") 
       Cycle 
     End If 
    Call ReadMatrixC(99,3,3,Y1eIN,1, "Y1eIN",kont)

 
   Else If (read_line(7:11).Eq."Y2EIN") Then 
InputValueforY2e= .True. 
    Call ReadMatrixC(99,3,3,Y2eIN,0, "Y2eIN",kont)

 
   Else If (read_line(7:13).Eq."IMY2EIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMY2e") 
       Cycle 
     End If 
    Call ReadMatrixC(99,3,3,Y2eIN,1, "Y2eIN",kont)
...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - BGLNCS_stripped Spectrum + Decays + Flavour Observables"
...
Write(io_L,101) 11, Real(v3input,dp) ,"# v3input"
Write(io_L,101) 12, Real(v1input,dp) ,"# v1input"
Write(io_L,101) 13, Real(v2input,dp) ,"# v2input"
...
End if 
End if 
Write(io_L,106) "Block Y1D Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Real(Y1d(1,1),dp), "# Real(Y1d(1,1),dp)" 
Write(io_L,107)1,2,Real(Y1d(1,2),dp), "# Real(Y1d(1,2),dp)" 
Write(io_L,107)1,3,Real(Y1d(1,3),dp), "# Real(Y1d(1,3),dp)" 
Write(io_L,107)2,1,Real(Y1d(2,1),dp), "# Real(Y1d(2,1),dp)" 
Write(io_L,107)2,2,Real(Y1d(2,2),dp), "# Real(Y1d(2,2),dp)" 
Write(io_L,107)2,3,Real(Y1d(2,3),dp), "# Real(Y1d(2,3),dp)" 
Write(io_L,107)3,1,Real(Y1d(3,1),dp), "# Real(Y1d(3,1),dp)" 
Write(io_L,107)3,2,Real(Y1d(3,2),dp), "# Real(Y1d(3,2),dp)" 
Write(io_L,107)3,3,Real(Y1d(3,3),dp), "# Real(Y1d(3,3),dp)" 
If ((MaxVal(Abs(AImag(Y1d))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMY1D Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Aimag(Y1d(1,1)), "# Aimag(Y1d(1,1))" 
Write(io_L,107)1,2,Aimag(Y1d(1,2)), "# Aimag(Y1d(1,2))" 
Write(io_L,107)1,3,Aimag(Y1d(1,3)), "# Aimag(Y1d(1,3))" 
Write(io_L,107)2,1,Aimag(Y1d(2,1)), "# Aimag(Y1d(2,1))" 
Write(io_L,107)2,2,Aimag(Y1d(2,2)), "# Aimag(Y1d(2,2))" 
Write(io_L,107)2,3,Aimag(Y1d(2,3)), "# Aimag(Y1d(2,3))" 
Write(io_L,107)3,1,Aimag(Y1d(3,1)), "# Aimag(Y1d(3,1))" 
Write(io_L,107)3,2,Aimag(Y1d(3,2)), "# Aimag(Y1d(3,2))" 
Write(io_L,107)3,3,Aimag(Y1d(3,3)), "# Aimag(Y1d(3,3))" 
End If 

Write(io_L,106) "Block Y2D Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Real(Y2d(1,1),dp), "# Real(Y2d(1,1),dp)" 
Write(io_L,107)1,2,Real(Y2d(1,2),dp), "# Real(Y2d(1,2),dp)" 
Write(io_L,107)1,3,Real(Y2d(1,3),dp), "# Real(Y2d(1,3),dp)" 
Write(io_L,107)2,1,Real(Y2d(2,1),dp), "# Real(Y2d(2,1),dp)" 
Write(io_L,107)2,2,Real(Y2d(2,2),dp), "# Real(Y2d(2,2),dp)" 
Write(io_L,107)2,3,Real(Y2d(2,3),dp), "# Real(Y2d(2,3),dp)" 
Write(io_L,107)3,1,Real(Y2d(3,1),dp), "# Real(Y2d(3,1),dp)" 
Write(io_L,107)3,2,Real(Y2d(3,2),dp), "# Real(Y2d(3,2),dp)" 
Write(io_L,107)3,3,Real(Y2d(3,3),dp), "# Real(Y2d(3,3),dp)" 
If ((MaxVal(Abs(AImag(Y2d))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMY2D Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Aimag(Y2d(1,1)), "# Aimag(Y2d(1,1))" 
Write(io_L,107)1,2,Aimag(Y2d(1,2)), "# Aimag(Y2d(1,2))" 
Write(io_L,107)1,3,Aimag(Y2d(1,3)), "# Aimag(Y2d(1,3))" 
Write(io_L,107)2,1,Aimag(Y2d(2,1)), "# Aimag(Y2d(2,1))" 
Write(io_L,107)2,2,Aimag(Y2d(2,2)), "# Aimag(Y2d(2,2))" 
Write(io_L,107)2,3,Aimag(Y2d(2,3)), "# Aimag(Y2d(2,3))" 
Write(io_L,107)3,1,Aimag(Y2d(3,1)), "# Aimag(Y2d(3,1))" 
Write(io_L,107)3,2,Aimag(Y2d(3,2)), "# Aimag(Y2d(3,2))" 
Write(io_L,107)3,3,Aimag(Y2d(3,3)), "# Aimag(Y2d(3,3))" 
End If 

Write(io_L,106) "Block Y1U Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Real(Y1u(1,1),dp), "# Real(Y1u(1,1),dp)" 
Write(io_L,107)1,2,Real(Y1u(1,2),dp), "# Real(Y1u(1,2),dp)" 
Write(io_L,107)1,3,Real(Y1u(1,3),dp), "# Real(Y1u(1,3),dp)" 
Write(io_L,107)2,1,Real(Y1u(2,1),dp), "# Real(Y1u(2,1),dp)" 
Write(io_L,107)2,2,Real(Y1u(2,2),dp), "# Real(Y1u(2,2),dp)" 
Write(io_L,107)2,3,Real(Y1u(2,3),dp), "# Real(Y1u(2,3),dp)" 
Write(io_L,107)3,1,Real(Y1u(3,1),dp), "# Real(Y1u(3,1),dp)" 
Write(io_L,107)3,2,Real(Y1u(3,2),dp), "# Real(Y1u(3,2),dp)" 
Write(io_L,107)3,3,Real(Y1u(3,3),dp), "# Real(Y1u(3,3),dp)" 
If ((MaxVal(Abs(AImag(Y1u))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMY1U Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Aimag(Y1u(1,1)), "# Aimag(Y1u(1,1))" 
Write(io_L,107)1,2,Aimag(Y1u(1,2)), "# Aimag(Y1u(1,2))" 
Write(io_L,107)1,3,Aimag(Y1u(1,3)), "# Aimag(Y1u(1,3))" 
Write(io_L,107)2,1,Aimag(Y1u(2,1)), "# Aimag(Y1u(2,1))" 
Write(io_L,107)2,2,Aimag(Y1u(2,2)), "# Aimag(Y1u(2,2))" 
Write(io_L,107)2,3,Aimag(Y1u(2,3)), "# Aimag(Y1u(2,3))" 
Write(io_L,107)3,1,Aimag(Y1u(3,1)), "# Aimag(Y1u(3,1))" 
Write(io_L,107)3,2,Aimag(Y1u(3,2)), "# Aimag(Y1u(3,2))" 
Write(io_L,107)3,3,Aimag(Y1u(3,3)), "# Aimag(Y1u(3,3))" 
End If 

Write(io_L,106) "Block Y2U Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Real(Y2u(1,1),dp), "# Real(Y2u(1,1),dp)" 
Write(io_L,107)1,2,Real(Y2u(1,2),dp), "# Real(Y2u(1,2),dp)" 
Write(io_L,107)1,3,Real(Y2u(1,3),dp), "# Real(Y2u(1,3),dp)" 
Write(io_L,107)2,1,Real(Y2u(2,1),dp), "# Real(Y2u(2,1),dp)" 
Write(io_L,107)2,2,Real(Y2u(2,2),dp), "# Real(Y2u(2,2),dp)" 
Write(io_L,107)2,3,Real(Y2u(2,3),dp), "# Real(Y2u(2,3),dp)" 
Write(io_L,107)3,1,Real(Y2u(3,1),dp), "# Real(Y2u(3,1),dp)" 
Write(io_L,107)3,2,Real(Y2u(3,2),dp), "# Real(Y2u(3,2),dp)" 
Write(io_L,107)3,3,Real(Y2u(3,3),dp), "# Real(Y2u(3,3),dp)" 
If ((MaxVal(Abs(AImag(Y2u))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMY2U Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Aimag(Y2u(1,1)), "# Aimag(Y2u(1,1))" 
Write(io_L,107)1,2,Aimag(Y2u(1,2)), "# Aimag(Y2u(1,2))" 
Write(io_L,107)1,3,Aimag(Y2u(1,3)), "# Aimag(Y2u(1,3))" 
Write(io_L,107)2,1,Aimag(Y2u(2,1)), "# Aimag(Y2u(2,1))" 
Write(io_L,107)2,2,Aimag(Y2u(2,2)), "# Aimag(Y2u(2,2))" 
Write(io_L,107)2,3,Aimag(Y2u(2,3)), "# Aimag(Y2u(2,3))" 
Write(io_L,107)3,1,Aimag(Y2u(3,1)), "# Aimag(Y2u(3,1))" 
Write(io_L,107)3,2,Aimag(Y2u(3,2)), "# Aimag(Y2u(3,2))" 
Write(io_L,107)3,3,Aimag(Y2u(3,3)), "# Aimag(Y2u(3,3))" 
End If 

Write(io_L,106) "Block Y1E Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Real(Y1e(1,1),dp), "# Real(Y1e(1,1),dp)" 
Write(io_L,107)1,2,Real(Y1e(1,2),dp), "# Real(Y1e(1,2),dp)" 
Write(io_L,107)1,3,Real(Y1e(1,3),dp), "# Real(Y1e(1,3),dp)" 
Write(io_L,107)2,1,Real(Y1e(2,1),dp), "# Real(Y1e(2,1),dp)" 
Write(io_L,107)2,2,Real(Y1e(2,2),dp), "# Real(Y1e(2,2),dp)" 
Write(io_L,107)2,3,Real(Y1e(2,3),dp), "# Real(Y1e(2,3),dp)" 
Write(io_L,107)3,1,Real(Y1e(3,1),dp), "# Real(Y1e(3,1),dp)" 
Write(io_L,107)3,2,Real(Y1e(3,2),dp), "# Real(Y1e(3,2),dp)" 
Write(io_L,107)3,3,Real(Y1e(3,3),dp), "# Real(Y1e(3,3),dp)" 
If ((MaxVal(Abs(AImag(Y1e))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMY1E Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Aimag(Y1e(1,1)), "# Aimag(Y1e(1,1))" 
Write(io_L,107)1,2,Aimag(Y1e(1,2)), "# Aimag(Y1e(1,2))" 
Write(io_L,107)1,3,Aimag(Y1e(1,3)), "# Aimag(Y1e(1,3))" 
Write(io_L,107)2,1,Aimag(Y1e(2,1)), "# Aimag(Y1e(2,1))" 
Write(io_L,107)2,2,Aimag(Y1e(2,2)), "# Aimag(Y1e(2,2))" 
Write(io_L,107)2,3,Aimag(Y1e(2,3)), "# Aimag(Y1e(2,3))" 
Write(io_L,107)3,1,Aimag(Y1e(3,1)), "# Aimag(Y1e(3,1))" 
Write(io_L,107)3,2,Aimag(Y1e(3,2)), "# Aimag(Y1e(3,2))" 
Write(io_L,107)3,3,Aimag(Y1e(3,3)), "# Aimag(Y1e(3,3))" 
End If 

Write(io_L,106) "Block Y2E Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Real(Y2e(1,1),dp), "# Real(Y2e(1,1),dp)" 
Write(io_L,107)1,2,Real(Y2e(1,2),dp), "# Real(Y2e(1,2),dp)" 
Write(io_L,107)1,3,Real(Y2e(1,3),dp), "# Real(Y2e(1,3),dp)" 
Write(io_L,107)2,1,Real(Y2e(2,1),dp), "# Real(Y2e(2,1),dp)" 
Write(io_L,107)2,2,Real(Y2e(2,2),dp), "# Real(Y2e(2,2),dp)" 
Write(io_L,107)2,3,Real(Y2e(2,3),dp), "# Real(Y2e(2,3),dp)" 
Write(io_L,107)3,1,Real(Y2e(3,1),dp), "# Real(Y2e(3,1),dp)" 
Write(io_L,107)3,2,Real(Y2e(3,2),dp), "# Real(Y2e(3,2),dp)" 
Write(io_L,107)3,3,Real(Y2e(3,3),dp), "# Real(Y2e(3,3),dp)" 
If ((MaxVal(Abs(AImag(Y2e))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMY2E Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Aimag(Y2e(1,1)), "# Aimag(Y2e(1,1))" 
Write(io_L,107)1,2,Aimag(Y2e(1,2)), "# Aimag(Y2e(1,2))" 
Write(io_L,107)1,3,Aimag(Y2e(1,3)), "# Aimag(Y2e(1,3))" 
Write(io_L,107)2,1,Aimag(Y2e(2,1)), "# Aimag(Y2e(2,1))" 
Write(io_L,107)2,2,Aimag(Y2e(2,2)), "# Aimag(Y2e(2,2))" 
Write(io_L,107)2,3,Aimag(Y2e(2,3)), "# Aimag(Y2e(2,3))" 
Write(io_L,107)3,1,Aimag(Y2e(3,1)), "# Aimag(Y2e(3,1))" 
Write(io_L,107)3,2,Aimag(Y2e(3,2)), "# Aimag(Y2e(3,2))" 
Write(io_L,107)3,3,Aimag(Y2e(3,3)), "# Aimag(Y2e(3,3))" 
End If 
...
Write(io_L,106) "Block Y1dGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(Y1dGUT(1,1),dp), "# Real(Y1dGUT(1,1),dp)" 
Write(io_L,107)1,2,Real(Y1dGUT(1,2),dp), "# Real(Y1dGUT(1,2),dp)" 
Write(io_L,107)1,3,Real(Y1dGUT(1,3),dp), "# Real(Y1dGUT(1,3),dp)" 
Write(io_L,107)2,1,Real(Y1dGUT(2,1),dp), "# Real(Y1dGUT(2,1),dp)" 
Write(io_L,107)2,2,Real(Y1dGUT(2,2),dp), "# Real(Y1dGUT(2,2),dp)" 
Write(io_L,107)2,3,Real(Y1dGUT(2,3),dp), "# Real(Y1dGUT(2,3),dp)" 
Write(io_L,107)3,1,Real(Y1dGUT(3,1),dp), "# Real(Y1dGUT(3,1),dp)" 
Write(io_L,107)3,2,Real(Y1dGUT(3,2),dp), "# Real(Y1dGUT(3,2),dp)" 
Write(io_L,107)3,3,Real(Y1dGUT(3,3),dp), "# Real(Y1dGUT(3,3),dp)" 
If ((MaxVal(Abs(AImag(Y1dGUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMY1dGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(Y1dGUT(1,1)), "# Aimag(Y1dGUT(1,1))" 
Write(io_L,107)1,2,Aimag(Y1dGUT(1,2)), "# Aimag(Y1dGUT(1,2))" 
Write(io_L,107)1,3,Aimag(Y1dGUT(1,3)), "# Aimag(Y1dGUT(1,3))" 
Write(io_L,107)2,1,Aimag(Y1dGUT(2,1)), "# Aimag(Y1dGUT(2,1))" 
Write(io_L,107)2,2,Aimag(Y1dGUT(2,2)), "# Aimag(Y1dGUT(2,2))" 
Write(io_L,107)2,3,Aimag(Y1dGUT(2,3)), "# Aimag(Y1dGUT(2,3))" 
Write(io_L,107)3,1,Aimag(Y1dGUT(3,1)), "# Aimag(Y1dGUT(3,1))" 
Write(io_L,107)3,2,Aimag(Y1dGUT(3,2)), "# Aimag(Y1dGUT(3,2))" 
Write(io_L,107)3,3,Aimag(Y1dGUT(3,3)), "# Aimag(Y1dGUT(3,3))" 
End If 

Write(io_L,106) "Block Y2dGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(Y2dGUT(1,1),dp), "# Real(Y2dGUT(1,1),dp)" 
Write(io_L,107)1,2,Real(Y2dGUT(1,2),dp), "# Real(Y2dGUT(1,2),dp)" 
Write(io_L,107)1,3,Real(Y2dGUT(1,3),dp), "# Real(Y2dGUT(1,3),dp)" 
Write(io_L,107)2,1,Real(Y2dGUT(2,1),dp), "# Real(Y2dGUT(2,1),dp)" 
Write(io_L,107)2,2,Real(Y2dGUT(2,2),dp), "# Real(Y2dGUT(2,2),dp)" 
Write(io_L,107)2,3,Real(Y2dGUT(2,3),dp), "# Real(Y2dGUT(2,3),dp)" 
Write(io_L,107)3,1,Real(Y2dGUT(3,1),dp), "# Real(Y2dGUT(3,1),dp)" 
Write(io_L,107)3,2,Real(Y2dGUT(3,2),dp), "# Real(Y2dGUT(3,2),dp)" 
Write(io_L,107)3,3,Real(Y2dGUT(3,3),dp), "# Real(Y2dGUT(3,3),dp)" 
If ((MaxVal(Abs(AImag(Y2dGUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMY2dGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(Y2dGUT(1,1)), "# Aimag(Y2dGUT(1,1))" 
Write(io_L,107)1,2,Aimag(Y2dGUT(1,2)), "# Aimag(Y2dGUT(1,2))" 
Write(io_L,107)1,3,Aimag(Y2dGUT(1,3)), "# Aimag(Y2dGUT(1,3))" 
Write(io_L,107)2,1,Aimag(Y2dGUT(2,1)), "# Aimag(Y2dGUT(2,1))" 
Write(io_L,107)2,2,Aimag(Y2dGUT(2,2)), "# Aimag(Y2dGUT(2,2))" 
Write(io_L,107)2,3,Aimag(Y2dGUT(2,3)), "# Aimag(Y2dGUT(2,3))" 
Write(io_L,107)3,1,Aimag(Y2dGUT(3,1)), "# Aimag(Y2dGUT(3,1))" 
Write(io_L,107)3,2,Aimag(Y2dGUT(3,2)), "# Aimag(Y2dGUT(3,2))" 
Write(io_L,107)3,3,Aimag(Y2dGUT(3,3)), "# Aimag(Y2dGUT(3,3))" 
End If 

Write(io_L,106) "Block Y1uGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(Y1uGUT(1,1),dp), "# Real(Y1uGUT(1,1),dp)" 
Write(io_L,107)1,2,Real(Y1uGUT(1,2),dp), "# Real(Y1uGUT(1,2),dp)" 
Write(io_L,107)1,3,Real(Y1uGUT(1,3),dp), "# Real(Y1uGUT(1,3),dp)" 
Write(io_L,107)2,1,Real(Y1uGUT(2,1),dp), "# Real(Y1uGUT(2,1),dp)" 
Write(io_L,107)2,2,Real(Y1uGUT(2,2),dp), "# Real(Y1uGUT(2,2),dp)" 
Write(io_L,107)2,3,Real(Y1uGUT(2,3),dp), "# Real(Y1uGUT(2,3),dp)" 
Write(io_L,107)3,1,Real(Y1uGUT(3,1),dp), "# Real(Y1uGUT(3,1),dp)" 
Write(io_L,107)3,2,Real(Y1uGUT(3,2),dp), "# Real(Y1uGUT(3,2),dp)" 
Write(io_L,107)3,3,Real(Y1uGUT(3,3),dp), "# Real(Y1uGUT(3,3),dp)" 
If ((MaxVal(Abs(AImag(Y1uGUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMY1uGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(Y1uGUT(1,1)), "# Aimag(Y1uGUT(1,1))" 
Write(io_L,107)1,2,Aimag(Y1uGUT(1,2)), "# Aimag(Y1uGUT(1,2))" 
Write(io_L,107)1,3,Aimag(Y1uGUT(1,3)), "# Aimag(Y1uGUT(1,3))" 
Write(io_L,107)2,1,Aimag(Y1uGUT(2,1)), "# Aimag(Y1uGUT(2,1))" 
Write(io_L,107)2,2,Aimag(Y1uGUT(2,2)), "# Aimag(Y1uGUT(2,2))" 
Write(io_L,107)2,3,Aimag(Y1uGUT(2,3)), "# Aimag(Y1uGUT(2,3))" 
Write(io_L,107)3,1,Aimag(Y1uGUT(3,1)), "# Aimag(Y1uGUT(3,1))" 
Write(io_L,107)3,2,Aimag(Y1uGUT(3,2)), "# Aimag(Y1uGUT(3,2))" 
Write(io_L,107)3,3,Aimag(Y1uGUT(3,3)), "# Aimag(Y1uGUT(3,3))" 
End If 

Write(io_L,106) "Block Y2uGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(Y2uGUT(1,1),dp), "# Real(Y2uGUT(1,1),dp)" 
Write(io_L,107)1,2,Real(Y2uGUT(1,2),dp), "# Real(Y2uGUT(1,2),dp)" 
Write(io_L,107)1,3,Real(Y2uGUT(1,3),dp), "# Real(Y2uGUT(1,3),dp)" 
Write(io_L,107)2,1,Real(Y2uGUT(2,1),dp), "# Real(Y2uGUT(2,1),dp)" 
Write(io_L,107)2,2,Real(Y2uGUT(2,2),dp), "# Real(Y2uGUT(2,2),dp)" 
Write(io_L,107)2,3,Real(Y2uGUT(2,3),dp), "# Real(Y2uGUT(2,3),dp)" 
Write(io_L,107)3,1,Real(Y2uGUT(3,1),dp), "# Real(Y2uGUT(3,1),dp)" 
Write(io_L,107)3,2,Real(Y2uGUT(3,2),dp), "# Real(Y2uGUT(3,2),dp)" 
Write(io_L,107)3,3,Real(Y2uGUT(3,3),dp), "# Real(Y2uGUT(3,3),dp)" 
If ((MaxVal(Abs(AImag(Y2uGUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMY2uGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(Y2uGUT(1,1)), "# Aimag(Y2uGUT(1,1))" 
Write(io_L,107)1,2,Aimag(Y2uGUT(1,2)), "# Aimag(Y2uGUT(1,2))" 
Write(io_L,107)1,3,Aimag(Y2uGUT(1,3)), "# Aimag(Y2uGUT(1,3))" 
Write(io_L,107)2,1,Aimag(Y2uGUT(2,1)), "# Aimag(Y2uGUT(2,1))" 
Write(io_L,107)2,2,Aimag(Y2uGUT(2,2)), "# Aimag(Y2uGUT(2,2))" 
Write(io_L,107)2,3,Aimag(Y2uGUT(2,3)), "# Aimag(Y2uGUT(2,3))" 
Write(io_L,107)3,1,Aimag(Y2uGUT(3,1)), "# Aimag(Y2uGUT(3,1))" 
Write(io_L,107)3,2,Aimag(Y2uGUT(3,2)), "# Aimag(Y2uGUT(3,2))" 
Write(io_L,107)3,3,Aimag(Y2uGUT(3,3)), "# Aimag(Y2uGUT(3,3))" 
End If 

Write(io_L,106) "Block Y1eGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(Y1eGUT(1,1),dp), "# Real(Y1eGUT(1,1),dp)" 
Write(io_L,107)1,2,Real(Y1eGUT(1,2),dp), "# Real(Y1eGUT(1,2),dp)" 
Write(io_L,107)1,3,Real(Y1eGUT(1,3),dp), "# Real(Y1eGUT(1,3),dp)" 
Write(io_L,107)2,1,Real(Y1eGUT(2,1),dp), "# Real(Y1eGUT(2,1),dp)" 
Write(io_L,107)2,2,Real(Y1eGUT(2,2),dp), "# Real(Y1eGUT(2,2),dp)" 
Write(io_L,107)2,3,Real(Y1eGUT(2,3),dp), "# Real(Y1eGUT(2,3),dp)" 
Write(io_L,107)3,1,Real(Y1eGUT(3,1),dp), "# Real(Y1eGUT(3,1),dp)" 
Write(io_L,107)3,2,Real(Y1eGUT(3,2),dp), "# Real(Y1eGUT(3,2),dp)" 
Write(io_L,107)3,3,Real(Y1eGUT(3,3),dp), "# Real(Y1eGUT(3,3),dp)" 
If ((MaxVal(Abs(AImag(Y1eGUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMY1eGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(Y1eGUT(1,1)), "# Aimag(Y1eGUT(1,1))" 
Write(io_L,107)1,2,Aimag(Y1eGUT(1,2)), "# Aimag(Y1eGUT(1,2))" 
Write(io_L,107)1,3,Aimag(Y1eGUT(1,3)), "# Aimag(Y1eGUT(1,3))" 
Write(io_L,107)2,1,Aimag(Y1eGUT(2,1)), "# Aimag(Y1eGUT(2,1))" 
Write(io_L,107)2,2,Aimag(Y1eGUT(2,2)), "# Aimag(Y1eGUT(2,2))" 
Write(io_L,107)2,3,Aimag(Y1eGUT(2,3)), "# Aimag(Y1eGUT(2,3))" 
Write(io_L,107)3,1,Aimag(Y1eGUT(3,1)), "# Aimag(Y1eGUT(3,1))" 
Write(io_L,107)3,2,Aimag(Y1eGUT(3,2)), "# Aimag(Y1eGUT(3,2))" 
Write(io_L,107)3,3,Aimag(Y1eGUT(3,3)), "# Aimag(Y1eGUT(3,3))" 
End If 

Write(io_L,106) "Block Y2eGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(Y2eGUT(1,1),dp), "# Real(Y2eGUT(1,1),dp)" 
Write(io_L,107)1,2,Real(Y2eGUT(1,2),dp), "# Real(Y2eGUT(1,2),dp)" 
Write(io_L,107)1,3,Real(Y2eGUT(1,3),dp), "# Real(Y2eGUT(1,3),dp)" 
Write(io_L,107)2,1,Real(Y2eGUT(2,1),dp), "# Real(Y2eGUT(2,1),dp)" 
Write(io_L,107)2,2,Real(Y2eGUT(2,2),dp), "# Real(Y2eGUT(2,2),dp)" 
Write(io_L,107)2,3,Real(Y2eGUT(2,3),dp), "# Real(Y2eGUT(2,3),dp)" 
Write(io_L,107)3,1,Real(Y2eGUT(3,1),dp), "# Real(Y2eGUT(3,1),dp)" 
Write(io_L,107)3,2,Real(Y2eGUT(3,2),dp), "# Real(Y2eGUT(3,2),dp)" 
Write(io_L,107)3,3,Real(Y2eGUT(3,3),dp), "# Real(Y2eGUT(3,3),dp)" 
If ((MaxVal(Abs(AImag(Y2eGUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMY2eGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(Y2eGUT(1,1)), "# Aimag(Y2eGUT(1,1))" 
Write(io_L,107)1,2,Aimag(Y2eGUT(1,2)), "# Aimag(Y2eGUT(1,2))" 
Write(io_L,107)1,3,Aimag(Y2eGUT(1,3)), "# Aimag(Y2eGUT(1,3))" 
Write(io_L,107)2,1,Aimag(Y2eGUT(2,1)), "# Aimag(Y2eGUT(2,1))" 
Write(io_L,107)2,2,Aimag(Y2eGUT(2,2)), "# Aimag(Y2eGUT(2,2))" 
Write(io_L,107)2,3,Aimag(Y2eGUT(2,3)), "# Aimag(Y2eGUT(2,3))" 
Write(io_L,107)3,1,Aimag(Y2eGUT(3,1)), "# Aimag(Y2eGUT(3,1))" 
Write(io_L,107)3,2,Aimag(Y2eGUT(3,2)), "# Aimag(Y2eGUT(3,2))" 
Write(io_L,107)3,3,Aimag(Y2eGUT(3,3)), "# Aimag(Y2eGUT(3,3))" 
End If 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.BGLNCS_stripped",status="unknown")
...
Write(123,*) "Y1d11_r= ",Real(Y1d(1,1),dp)
Write(123,*) "Y1d12_r= ",Real(Y1d(1,2),dp)
Write(123,*) "Y1d13_r= ",Real(Y1d(1,3),dp)
Write(123,*) "Y1d21_r= ",Real(Y1d(2,1),dp)
Write(123,*) "Y1d22_r= ",Real(Y1d(2,2),dp)
Write(123,*) "Y1d23_r= ",Real(Y1d(2,3),dp)
Write(123,*) "Y1d31_r= ",Real(Y1d(3,1),dp)
Write(123,*) "Y1d32_r= ",Real(Y1d(3,2),dp)
Write(123,*) "Y1d33_r= ",Real(Y1d(3,3),dp)
Write(123,*) "Y1d11_i= ",AImag(Y1d(1,1))
Write(123,*) "Y1d12_i= ",AImag(Y1d(1,2))
Write(123,*) "Y1d13_i= ",AImag(Y1d(1,3))
Write(123,*) "Y1d21_i= ",AImag(Y1d(2,1))
Write(123,*) "Y1d22_i= ",AImag(Y1d(2,2))
Write(123,*) "Y1d23_i= ",AImag(Y1d(2,3))
Write(123,*) "Y1d31_i= ",AImag(Y1d(3,1))
Write(123,*) "Y1d32_i= ",AImag(Y1d(3,2))
Write(123,*) "Y1d33_i= ",AImag(Y1d(3,3))
Write(123,*) "Y2d11_r= ",Real(Y2d(1,1),dp)
Write(123,*) "Y2d12_r= ",Real(Y2d(1,2),dp)
Write(123,*) "Y2d13_r= ",Real(Y2d(1,3),dp)
Write(123,*) "Y2d21_r= ",Real(Y2d(2,1),dp)
Write(123,*) "Y2d22_r= ",Real(Y2d(2,2),dp)
Write(123,*) "Y2d23_r= ",Real(Y2d(2,3),dp)
Write(123,*) "Y2d31_r= ",Real(Y2d(3,1),dp)
Write(123,*) "Y2d32_r= ",Real(Y2d(3,2),dp)
Write(123,*) "Y2d33_r= ",Real(Y2d(3,3),dp)
Write(123,*) "Y2d11_i= ",AImag(Y2d(1,1))
Write(123,*) "Y2d12_i= ",AImag(Y2d(1,2))
Write(123,*) "Y2d13_i= ",AImag(Y2d(1,3))
Write(123,*) "Y2d21_i= ",AImag(Y2d(2,1))
Write(123,*) "Y2d22_i= ",AImag(Y2d(2,2))
Write(123,*) "Y2d23_i= ",AImag(Y2d(2,3))
Write(123,*) "Y2d31_i= ",AImag(Y2d(3,1))
Write(123,*) "Y2d32_i= ",AImag(Y2d(3,2))
Write(123,*) "Y2d33_i= ",AImag(Y2d(3,3))
Write(123,*) "Y1u11_r= ",Real(Y1u(1,1),dp)
Write(123,*) "Y1u12_r= ",Real(Y1u(1,2),dp)
Write(123,*) "Y1u13_r= ",Real(Y1u(1,3),dp)
Write(123,*) "Y1u21_r= ",Real(Y1u(2,1),dp)
Write(123,*) "Y1u22_r= ",Real(Y1u(2,2),dp)
Write(123,*) "Y1u23_r= ",Real(Y1u(2,3),dp)
Write(123,*) "Y1u31_r= ",Real(Y1u(3,1),dp)
Write(123,*) "Y1u32_r= ",Real(Y1u(3,2),dp)
Write(123,*) "Y1u33_r= ",Real(Y1u(3,3),dp)
Write(123,*) "Y1u11_i= ",AImag(Y1u(1,1))
Write(123,*) "Y1u12_i= ",AImag(Y1u(1,2))
Write(123,*) "Y1u13_i= ",AImag(Y1u(1,3))
Write(123,*) "Y1u21_i= ",AImag(Y1u(2,1))
Write(123,*) "Y1u22_i= ",AImag(Y1u(2,2))
Write(123,*) "Y1u23_i= ",AImag(Y1u(2,3))
Write(123,*) "Y1u31_i= ",AImag(Y1u(3,1))
Write(123,*) "Y1u32_i= ",AImag(Y1u(3,2))
Write(123,*) "Y1u33_i= ",AImag(Y1u(3,3))
Write(123,*) "Y2u11_r= ",Real(Y2u(1,1),dp)
Write(123,*) "Y2u12_r= ",Real(Y2u(1,2),dp)
Write(123,*) "Y2u13_r= ",Real(Y2u(1,3),dp)
Write(123,*) "Y2u21_r= ",Real(Y2u(2,1),dp)
Write(123,*) "Y2u22_r= ",Real(Y2u(2,2),dp)
Write(123,*) "Y2u23_r= ",Real(Y2u(2,3),dp)
Write(123,*) "Y2u31_r= ",Real(Y2u(3,1),dp)
Write(123,*) "Y2u32_r= ",Real(Y2u(3,2),dp)
Write(123,*) "Y2u33_r= ",Real(Y2u(3,3),dp)
Write(123,*) "Y2u11_i= ",AImag(Y2u(1,1))
Write(123,*) "Y2u12_i= ",AImag(Y2u(1,2))
Write(123,*) "Y2u13_i= ",AImag(Y2u(1,3))
Write(123,*) "Y2u21_i= ",AImag(Y2u(2,1))
Write(123,*) "Y2u22_i= ",AImag(Y2u(2,2))
Write(123,*) "Y2u23_i= ",AImag(Y2u(2,3))
Write(123,*) "Y2u31_i= ",AImag(Y2u(3,1))
Write(123,*) "Y2u32_i= ",AImag(Y2u(3,2))
Write(123,*) "Y2u33_i= ",AImag(Y2u(3,3))
Write(123,*) "Y1e11_r= ",Real(Y1e(1,1),dp)
Write(123,*) "Y1e12_r= ",Real(Y1e(1,2),dp)
Write(123,*) "Y1e13_r= ",Real(Y1e(1,3),dp)
Write(123,*) "Y1e21_r= ",Real(Y1e(2,1),dp)
Write(123,*) "Y1e22_r= ",Real(Y1e(2,2),dp)
Write(123,*) "Y1e23_r= ",Real(Y1e(2,3),dp)
Write(123,*) "Y1e31_r= ",Real(Y1e(3,1),dp)
Write(123,*) "Y1e32_r= ",Real(Y1e(3,2),dp)
Write(123,*) "Y1e33_r= ",Real(Y1e(3,3),dp)
Write(123,*) "Y1e11_i= ",AImag(Y1e(1,1))
Write(123,*) "Y1e12_i= ",AImag(Y1e(1,2))
Write(123,*) "Y1e13_i= ",AImag(Y1e(1,3))
Write(123,*) "Y1e21_i= ",AImag(Y1e(2,1))
Write(123,*) "Y1e22_i= ",AImag(Y1e(2,2))
Write(123,*) "Y1e23_i= ",AImag(Y1e(2,3))
Write(123,*) "Y1e31_i= ",AImag(Y1e(3,1))
Write(123,*) "Y1e32_i= ",AImag(Y1e(3,2))
Write(123,*) "Y1e33_i= ",AImag(Y1e(3,3))
Write(123,*) "Y2e11_r= ",Real(Y2e(1,1),dp)
Write(123,*) "Y2e12_r= ",Real(Y2e(1,2),dp)
Write(123,*) "Y2e13_r= ",Real(Y2e(1,3),dp)
Write(123,*) "Y2e21_r= ",Real(Y2e(2,1),dp)
Write(123,*) "Y2e22_r= ",Real(Y2e(2,2),dp)
Write(123,*) "Y2e23_r= ",Real(Y2e(2,3),dp)
Write(123,*) "Y2e31_r= ",Real(Y2e(3,1),dp)
Write(123,*) "Y2e32_r= ",Real(Y2e(3,2),dp)
Write(123,*) "Y2e33_r= ",Real(Y2e(3,3),dp)
Write(123,*) "Y2e11_i= ",AImag(Y2e(1,1))
Write(123,*) "Y2e12_i= ",AImag(Y2e(1,2))
Write(123,*) "Y2e13_i= ",AImag(Y2e(1,3))
Write(123,*) "Y2e21_i= ",AImag(Y2e(2,1))
Write(123,*) "Y2e22_i= ",AImag(Y2e(2,2))
Write(123,*) "Y2e23_i= ",AImag(Y2e(2,3))
Write(123,*) "Y2e31_i= ",AImag(Y2e(3,1))
Write(123,*) "Y2e32_i= ",AImag(Y2e(3,2))
Write(123,*) "Y2e33_i= ",AImag(Y2e(3,3))
...
Subroutine WriteWCXF 
   Open(123,file="WC.BGLNCS_stripped_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.BGLNCS_stripped_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
...
End Module InputOutput_BGLNCS_stripped 
