...
Module TreeLevelDecays_BGLCS
 
Use Control 
Use DecayFunctions 
Use Settings 
Use LoopCouplings_BGLCS 
Use CouplingsForDecays_BGLCS 
...
& Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,v1,v2,v3,gPartial,gT,BR)
...
& Y1e21,Y1e22,Y2e33,Aa1,Mub,Mu3,ZDR(3,3),ZER(3,3),ZUR(3,3),ZDL(3,3),ZEL(3,3),            & 
& ZUL(3,3),ZP(2,2),ZW(2,2),ZZ(2,2)
...
& ZP,ZW,ZZ,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,Y1d11,Y1d12,          & 
& Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,               & 
& Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,v1,v2,v3,cplcFuFuAhL,         & 
...
& ZP,ZW,ZZ,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,Y1d11,Y1d12,          & 
& Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,               & 
& Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,v1,v2,v3,cplcFeFeAhL,         & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFv1HmL,              & 
& cplcFeFv1HmR,cplcFeFv1VWmL,cplcFeFv1VWmR,cplcFeFv2HmL,cplcFeFv2HmR,cplcFeFv2VWmL,      & 
& cplcFeFv2VWmR,cplcFeFv3HmL,cplcFeFv3HmR,cplcFeFv3VWmL,cplcFeFv3VWmR,deltaM)
...
m1out = 0._dp
m2out = MHm(gt2)
coupL = cplcFeFv1HmL(i1,gt2)
coupR = cplcFeFv1HmR(i1,gt2)
Call FermionToFermionScalar(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
m1out = 0._dp
m2out = MVWm
coupL = cplcFeFv1VWmL(i1)
coupR = cplcFeFv1VWmR(i1)
Call FermionToFermionVectorBoson(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
m1out = 0._dp
m2out = MHm(gt2)
coupL = cplcFeFv2HmL(i1,gt2)
coupR = cplcFeFv2HmR(i1,gt2)
Call FermionToFermionScalar(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
m1out = 0._dp
m2out = MVWm
coupL = cplcFeFv2VWmL(i1)
coupR = cplcFeFv2VWmR(i1)
Call FermionToFermionVectorBoson(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
m1out = 0._dp
m2out = MHm(gt2)
coupL = cplcFeFv3HmL(i1,gt2)
coupR = cplcFeFv3HmR(i1,gt2)
Call FermionToFermionScalar(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
m1out = 0._dp
m2out = MVWm
coupL = cplcFeFv3VWmL(i1)
coupR = cplcFeFv3VWmR(i1)
Call FermionToFermionVectorBoson(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
& ZP,ZW,ZZ,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,Y1d11,Y1d12,          & 
& Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,               & 
& Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,v1,v2,v3,cplcFdFdAhL,         & 
& cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,               & 
& cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,deltaM)
...
& ZP,ZW,ZZ,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,Y1d11,Y1d12,          & 
& Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,               & 
& Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,v1,v2,v3,cplHiggsPP,          & 
& cplHiggsGG,cplHiggsZZvirt,cplHiggsWWvirt,cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplcFdFdhhL,    & 
...
& ZP,ZW,ZZ,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,Y1d11,Y1d12,          & 
& Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,               & 
& Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,v1,v2,v3,cplPseudoHiggsPP,    & 
& cplPseudoHiggsGG,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,              & 
& cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,deltaM)
...
& ZP,ZW,ZZ,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,Y1d11,Y1d12,          & 
& Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,               & 
& Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,v1,v2,v3,cplAhHmcHm,          & 
& cplAhcHmVWm,cplcFuFdcHmL,cplcFuFdcHmR,cplcFv1FecHmL,cplcFv1FecHmR,cplcFv2FecHmL,       & 
& cplcFv2FecHmR,cplcFv3FecHmL,cplcFv3FecHmR,cplhhHmcHm,cplhhcHmVWm,cplHmcHmVZ,           & 
& cplcHmVWmVZ,deltaM)
...
m1out = 0._dp
m2out = MFe(gt2)
coupL = cplcFv1FecHmL(gt2,i1)
coupR = cplcFv1FecHmR(gt2,i1)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
m1out = 0._dp
m2out = MFe(gt2)
coupL = cplcFv2FecHmL(gt2,i1)
coupR = cplcFv2FecHmR(gt2,i1)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
m1out = 0._dp
m2out = MFe(gt2)
coupL = cplcFv3FecHmL(gt2,i1)
coupR = cplcFv3FecHmR(gt2,i1)
Call ScalarToTwoFermions(m_in,m1out,m2out,coupL,coupR,gam) 
gPartial(i1,i_count) = 1*gam 
gT(i1) = gT(i1) + gPartial(i1,i_count) 
i_count = i_count +1 
...
& ZP,ZW,ZZ,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,Y1d11,Y1d12,          & 
& Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,               & 
& Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,v1,v2,v3,cplAhhhVZ,           & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplcFv1Fv1VZL,cplcFv1Fv1VZR,cplcFv2Fv2VZL,cplcFv2Fv2VZR,cplcFv3Fv3VZL,cplcFv3Fv3VZR,   & 
...
Complex(dp) :: cplAhHmcVWm(3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFv1FecVWmL(3),             & 
...
& ZA,ZH,ZP,ZW,ZZ,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,Y1d11,          & 
& Y1d12,Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,Y1u12,Y1u21,Y1u22,               & 
& Y2u33,Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,v1,v2,v3,               & 
& cplAhHmcVWm,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFv1FecVWmL,cplcFv1FecVWmR,cplcFv2FecVWmL,  & 
& cplcFv2FecVWmR,cplcFv3FecVWmL,cplcFv3FecVWmR,cplhhHmcVWm,cplhhcVWmVWm,cplHmcVWmVZ,     & 
& cplcVWmVWmVZ,deltaM)
...
m1out = 0._dp
m2out = MFe(gt2)
coupL = cplcFv1FecVWmL(gt2)
coupR = cplcFv1FecVWmR(gt2)
Call VectorBosonToTwoFermions(m_in,m1out,m2out,1,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
m1out = 0._dp
m2out = MFe(gt2)
coupL = cplcFv2FecVWmL(gt2)
coupR = cplcFv2FecVWmR(gt2)
Call VectorBosonToTwoFermions(m_in,m1out,m2out,1,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
m1out = 0._dp
m2out = MFe(gt2)
coupL = cplcFv3FecVWmL(gt2)
coupR = cplcFv3FecVWmR(gt2)
Call VectorBosonToTwoFermions(m_in,m1out,m2out,1,coupL,coupR,gam) 
gPartial(1,i_count) = 1*gam 
gT = gT + gPartial(1,i_count) 
i_count = i_count +1 
...
End Module TreeLevelDecays_BGLCS 
