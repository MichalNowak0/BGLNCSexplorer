...
Module TreeLevelMasses_BGLNCS_stripped 
...
& Y2u,Y1e,Y2e,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,GenerationMixing,kont)
...
Complex(dp),Intent(out) :: ZDR(3,3),ZER(3,3),ZUR(3,3),ZDL(3,3),ZEL(3,3),ZUL(3,3),ZP(2,2),ZW(2,2),ZZ(2,2)
...
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesBGLNCS_stripped'
...
& Lam3Dash,Mub,Mu3,Aa1,v1,v2,v3,ZH,Mhh,Mhh2,kont)

kontSave = kont 
Call CalculateMAh(g1,g2,Mu1,Mu2,Lam1,Lam3,Lam4,Lam2,MuDash,Lam1Dash,Lam2Dash,         & 
& Lam3Dash,Mub,Mu3,Aa1,v1,v2,v3,ZZ,ZA,MAh,MAh2,kont)

kont = kontSave 
kontSave = kont 
Call CalculateMHm(g2,Mu1,Mu2,Lam1,Lam3,Lam4,Lam2,Lam2Dash,Lam3Dash,Mu3,               & 
& Aa1,v1,v2,v3,ZP,MHm,MHm2,kont)

kont = kontSave 
Call CalculateMFd(Y1d,Y2d,v1,v2,ZDL,ZDR,MFd,kont)

MFd2 = MFd**2 
Call CalculateMFu(Y1u,Y2u,v1,v2,ZUL,ZUR,MFu,kont)

MFu2 = MFu**2 
Call CalculateMFe(Y1e,Y2e,v1,v2,ZEL,ZER,MFe,kont)
...
& v1,v2,v3,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,Y1d,Y2d,              & 
& Y1u,Y2u,Y1e,Y2e,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,kont)
...
& v1,v2,v3,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,Y1d,Y2d,              & 
& Y1u,Y2u,Y1e,Y2e,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,GenerationMixing,kont)
...
& Lam2Dash,Lam3Dash,Mub,Mu3,Aa1,v1,v2,v3,ZZ,ZA,MAh,MAh2,kont)

kont = kontSave 
kontSave = kont 
Call CalculateMHmEffPot(g2,Mu1,Mu2,Lam1,Lam3,Lam4,Lam2,Lam2Dash,Lam3Dash,             & 
& Mu3,Aa1,v1,v2,v3,ZP,MHm,MHm2,kont)

kont = kontSave 
Call CalculateMFdEffPot(Y1d,Y2d,v1,v2,ZDL,ZDR,MFd,kont)

MFd2 = MFd**2 
Call CalculateMFuEffPot(Y1u,Y2u,v1,v2,ZUL,ZUR,MFu,kont)

MFu2 = MFu**2 
Call CalculateMFeEffPot(Y1e,Y2e,v1,v2,ZEL,ZER,MFe,kont)
...
Subroutine CalculateMFd(Y1d,Y2d,v1,v2,ZDL,ZDR,MFd,kont)
...
ZDR = 0._dp 
mat(1,1) = 0._dp 
mat(1,1) = mat(1,1)+(v1*Y1d(1,1))/sqrt(2._dp)
mat(1,1) = mat(1,1)+(v2*Y2d(1,1))/sqrt(2._dp)
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)+(v1*Y1d(1,2))/sqrt(2._dp)
mat(1,2) = mat(1,2)+(v2*Y2d(1,2))/sqrt(2._dp)
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)+(v1*Y1d(1,3))/sqrt(2._dp)
mat(1,3) = mat(1,3)+(v2*Y2d(1,3))/sqrt(2._dp)
mat(2,1) = 0._dp 
mat(2,1) = mat(2,1)+(v1*Y1d(2,1))/sqrt(2._dp)
mat(2,1) = mat(2,1)+(v2*Y2d(2,1))/sqrt(2._dp)
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(v1*Y1d(2,2))/sqrt(2._dp)
mat(2,2) = mat(2,2)+(v2*Y2d(2,2))/sqrt(2._dp)
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+(v1*Y1d(2,3))/sqrt(2._dp)
mat(2,3) = mat(2,3)+(v2*Y2d(2,3))/sqrt(2._dp)
mat(3,1) = 0._dp 
mat(3,1) = mat(3,1)+(v1*Y1d(3,1))/sqrt(2._dp)
mat(3,1) = mat(3,1)+(v2*Y2d(3,1))/sqrt(2._dp)
mat(3,2) = 0._dp 
mat(3,2) = mat(3,2)+(v1*Y1d(3,2))/sqrt(2._dp)
mat(3,2) = mat(3,2)+(v2*Y2d(3,2))/sqrt(2._dp)
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(v1*Y1d(3,3))/sqrt(2._dp)
mat(3,3) = mat(3,3)+(v2*Y2d(3,3))/sqrt(2._dp)
...
Subroutine CalculateMFu(Y1u,Y2u,v1,v2,ZUL,ZUR,MFu,kont)
...
ZUR = 0._dp 
mat(1,1) = 0._dp 
mat(1,1) = mat(1,1)+(v1*Y1u(1,1))/sqrt(2._dp)
mat(1,1) = mat(1,1)+(v2*Y2u(1,1))/sqrt(2._dp)
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)+(v1*Y1u(1,2))/sqrt(2._dp)
mat(1,2) = mat(1,2)+(v2*Y2u(1,2))/sqrt(2._dp)
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)+(v1*Y1u(1,3))/sqrt(2._dp)
mat(1,3) = mat(1,3)+(v2*Y2u(1,3))/sqrt(2._dp)
mat(2,1) = 0._dp 
mat(2,1) = mat(2,1)+(v1*Y1u(2,1))/sqrt(2._dp)
mat(2,1) = mat(2,1)+(v2*Y2u(2,1))/sqrt(2._dp)
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(v1*Y1u(2,2))/sqrt(2._dp)
mat(2,2) = mat(2,2)+(v2*Y2u(2,2))/sqrt(2._dp)
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+(v1*Y1u(2,3))/sqrt(2._dp)
mat(2,3) = mat(2,3)+(v2*Y2u(2,3))/sqrt(2._dp)
mat(3,1) = 0._dp 
mat(3,1) = mat(3,1)+(v1*Y1u(3,1))/sqrt(2._dp)
mat(3,1) = mat(3,1)+(v2*Y2u(3,1))/sqrt(2._dp)
mat(3,2) = 0._dp 
mat(3,2) = mat(3,2)+(v1*Y1u(3,2))/sqrt(2._dp)
mat(3,2) = mat(3,2)+(v2*Y2u(3,2))/sqrt(2._dp)
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(v1*Y1u(3,3))/sqrt(2._dp)
mat(3,3) = mat(3,3)+(v2*Y2u(3,3))/sqrt(2._dp)
...
Subroutine CalculateMFe(Y1e,Y2e,v1,v2,ZEL,ZER,MFe,kont)
...
ZER = 0._dp 
mat(1,1) = 0._dp 
mat(1,1) = mat(1,1)+(v1*Y1e(1,1))/sqrt(2._dp)
mat(1,1) = mat(1,1)+(v2*Y2e(1,1))/sqrt(2._dp)
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)+(v1*Y1e(1,2))/sqrt(2._dp)
mat(1,2) = mat(1,2)+(v2*Y2e(1,2))/sqrt(2._dp)
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)+(v1*Y1e(1,3))/sqrt(2._dp)
mat(1,3) = mat(1,3)+(v2*Y2e(1,3))/sqrt(2._dp)
mat(2,1) = 0._dp 
mat(2,1) = mat(2,1)+(v1*Y1e(2,1))/sqrt(2._dp)
mat(2,1) = mat(2,1)+(v2*Y2e(2,1))/sqrt(2._dp)
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(v1*Y1e(2,2))/sqrt(2._dp)
mat(2,2) = mat(2,2)+(v2*Y2e(2,2))/sqrt(2._dp)
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+(v1*Y1e(2,3))/sqrt(2._dp)
mat(2,3) = mat(2,3)+(v2*Y2e(2,3))/sqrt(2._dp)
mat(3,1) = 0._dp 
mat(3,1) = mat(3,1)+(v1*Y1e(3,1))/sqrt(2._dp)
mat(3,1) = mat(3,1)+(v2*Y2e(3,1))/sqrt(2._dp)
mat(3,2) = 0._dp 
mat(3,2) = mat(3,2)+(v1*Y1e(3,2))/sqrt(2._dp)
mat(3,2) = mat(3,2)+(v2*Y2e(3,2))/sqrt(2._dp)
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(v1*Y1e(3,3))/sqrt(2._dp)
mat(3,3) = mat(3,3)+(v2*Y2e(3,3))/sqrt(2._dp)
...
& Lam2Dash,Lam3Dash,Mub,Mu3,Aa1,v1,v2,v3,ZH,Mhh,Mhh2,kont)
...
& Lam1Dash,Lam2Dash,Lam3Dash,Mub,Mu3,Aa1,v1,v2,v3,ZZ,ZA,MAh,MAh2,kont)
...
Subroutine CalculateMFdEffPot(Y1d,Y2d,v1,v2,ZDL,ZDR,MFd,kont)
...
Subroutine CalculateMFuEffPot(Y1u,Y2u,v1,v2,ZUL,ZUR,MFu,kont)
...
Subroutine CalculateMFeEffPot(Y1e,Y2e,v1,v2,ZEL,ZER,MFe,kont)
...
& ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,v1,v2,v3,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,          & 
& Lam2Dash,Lam3Dash,Y1d,Y2d,Y1u,Y2u,Y1e,Y2e,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,GenerationMixing,kont)
...
Real(dp),Intent(out) :: MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),MVWm,MVWm2,MVZ,MVZ2

Complex(dp),Intent(out) :: ZDR(3,3),ZER(3,3),ZUR(3,3),ZDL(3,3),ZEL(3,3),ZUL(3,3),ZW(2,2),ZZ(2,2)
...
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,v,ZDL,ZEL,ZUL,ZA,ZH,ZP,ZW,ZZ,kont)
...
End Module TreeLevelMasses_BGLNCS_stripped 
