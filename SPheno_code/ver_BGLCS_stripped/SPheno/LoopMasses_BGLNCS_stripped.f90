...
Module LoopMasses_BGLNCS_stripped 
...
Use StandardModel 
Use Tadpoles_BGLNCS_stripped 
 Use Pole2L_BGLNCS_stripped 
 Use TreeLevelMasses_BGLNCS_stripped 
...
& v2,v3,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,Y1d,Y2d,Y1u,             & 
& Y2u,Y1e,Y2e,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,kont)
...
& cplcFvFecUHmR(3,3,2),cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),cplcFvFvVPL(3,3),           & 
& cplcFvFvVPR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcgAgWmcVWm,cplcgGgGVG,           & 
& cplcgWmgWmUAh(3),cplcgWmgWmUhh(3),cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWmgZUHm(2),           & 
...
& cplcUFvFecVWmL(3,3),cplcUFvFecVWmR(3,3),cplcUFvFvVPL(3,3),cplcUFvFvVPR(3,3),           & 
& cplcUFvFvVZL(3,3),cplcUFvFvVZR(3,3),cplcUHmVPVWm(2),cplcUHmVWmVZ(2),cplcVWmcVWmVWmVWm1,& 
...
& cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplhhcUHmVWm(3,2),cplhhcVWmVWm(3),     & 
& cplhhhhcVWmVWm(3,3),cplhhhhUHmcUHm(3,3,2,2),cplhhhhVPVP(3,3),cplhhhhVPVZ(3,3),         & 
& cplhhhhVZVZ(3,3),cplhhHmcUHm(3,2,2),cplhhHmcVWm(3,2),cplhhVPVZ(3),cplhhVZVZ(3),        & 
...
& cplHmcVWmVZ(2),cplUAhAhAh(3,3,3),cplUAhAhhh(3,3,3),cplUAhhhhh(3,3,3),cplUAhhhVP(3,3)

Complex(dp) :: cplUAhhhVZ(3,3),cplUAhHmcHm(3,2,2),cplUAhHmcVWm(3,2),cplUAhUAhAhAh(3,3,3,3),           & 
& cplUAhUAhcVWmVWm(3,3),cplUAhUAhhhhh(3,3,3,3),cplUAhUAhHmcHm(3,3,2,2),cplUAhUAhVPVP(3,3),& 
& cplUAhUAhVZVZ(3,3),cplUhhcVWmVWm(3),cplUhhhhhh(3,3,3),cplUhhHmcHm(3,2,2),              & 
& cplUhhHmcVWm(3,2),cplUhhUhhcVWmVWm(3,3),cplUhhUhhhhhh(3,3,3,3),cplUhhUhhHmcHm(3,3,2,2),& 
& cplUhhUhhVPVP(3,3),cplUhhUhhVZVZ(3,3),cplUhhVPVZ(3),cplUhhVZVZ(3),cplUHmcUHmcVWmVWm(2,2),& 
& cplUHmcUHmVPVP(2,2),cplUHmcUHmVZVZ(2,2),cplUHmHmcUHmcHm(2,2,2,2),cplVGVGVG,            & 
...
& ZUR,ZP,g3,cplAhAhUhh,cplAhUhhhh,cplAhUhhVP,cplAhUhhVZ,cplcFdFdUhhL,cplcFdFdUhhR,       & 
...
& cplUAhUAhHmcHm,cplUAhUAhVPVP,cplUAhUAhcVWmVWm,cplUAhUAhVZVZ,cplAhHmcUHm,               & 
...
& cplcUFeFvVWmL,cplcUFeFvVWmR,cplcUFvFecHmL,cplcUFvFecHmR,cplcUFvFecVWmL,cplcUFvFecVWmR, & 
& cplcUFvFvVPL,cplcUFvFvVPR,cplcUFvFvVZL,cplcUFvFvVZR,cplcFdFdVGL,cplcFdFdVGR,           & 
...
CASE ( 1 , 2 ) 
 ...
 CASE ( 3 ) ! Diagrammatic method 
  ! Make sure that there are no exactly degenerated masses! 
   Y1d_saveEP =Y1d
   where (aint(Abs(Y1d)).eq.Y1d) Y1d=Y1d*(1 + 1*1.0E-12_dp)
   Y2d_saveEP =Y2d
   where (aint(Abs(Y2d)).eq.Y2d) Y2d=Y2d*(1 + 2*1.0E-12_dp)
   Y1u_saveEP =Y1u
   where (aint(Abs(Y1u)).eq.Y1u) Y1u=Y1u*(1 + 3*1.0E-12_dp)
   Y2u_saveEP =Y2u
   where (aint(Abs(Y2u)).eq.Y2u) Y2u=Y2u*(1 + 4*1.0E-12_dp)
   Y1e_saveEP =Y1e
   where (aint(Abs(Y1e)).eq.Y1e) Y1e=Y1e*(1 + 5*1.0E-12_dp)
   Y2e_saveEP =Y2e
   where (aint(Abs(Y2e)).eq.Y2e) Y2e=Y2e*(1 + 6*1.0E-12_dp)

If (NewGBC) Then 
Call CalculatePi2S(125._dp**2,v1,v2,v3,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,         & 
& Lam2Dash,Lam3Dash,Y1d,Y2d,Y1u,Y2u,Y1e,Y2e,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,kont,             & 
...
End if 
Call SolveTadpoleEquations(g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,            & 
& Lam3Dash,Y1d,Y2d,Y1u,Y2u,Y1e,Y2e,Aa1,Mu1,Mu2,MuDash,Mub,Mu3,v1,v2,v3,Tad1Loop)
...
& Mhh2,MVZ,MVZ2,cplAhHmcUHm,cplAhcUHmVWm,cplcFuFdcUHmL,cplcFuFdcUHmR,cplcFvFecUHmL,      & 
& cplcFvFecUHmR,cplcgZgWmcUHm,cplcgWmgZUHm,cplcgWpgZcUHm,cplcgZgWpUHm,cplhhHmcUHm,       & 
...
& cplcFvFecUHmL,cplcFvFecUHmR,cplcgZgWmcUHm,cplcgWmgZUHm,cplcgWpgZcUHm,cplcgZgWpUHm,     & 
...
Subroutine OneLoopFd(Y1d,Y2d,v1,v2,MFd,MFd2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,               & 
...
Complex(dp), Intent(in) :: Y1d(3,3),Y2d(3,3)
...
mat1a(1,1) = 0._dp 
mat1a(1,1) = mat1a(1,1)+(v1*Y1d(1,1))/sqrt(2._dp)
mat1a(1,1) = mat1a(1,1)+(v2*Y2d(1,1))/sqrt(2._dp)
mat1a(1,2) = 0._dp 
mat1a(1,2) = mat1a(1,2)+(v1*Y1d(1,2))/sqrt(2._dp)
mat1a(1,2) = mat1a(1,2)+(v2*Y2d(1,2))/sqrt(2._dp)
mat1a(1,3) = 0._dp 
mat1a(1,3) = mat1a(1,3)+(v1*Y1d(1,3))/sqrt(2._dp)
mat1a(1,3) = mat1a(1,3)+(v2*Y2d(1,3))/sqrt(2._dp)
mat1a(2,1) = 0._dp 
mat1a(2,1) = mat1a(2,1)+(v1*Y1d(2,1))/sqrt(2._dp)
mat1a(2,1) = mat1a(2,1)+(v2*Y2d(2,1))/sqrt(2._dp)
mat1a(2,2) = 0._dp 
mat1a(2,2) = mat1a(2,2)+(v1*Y1d(2,2))/sqrt(2._dp)
mat1a(2,2) = mat1a(2,2)+(v2*Y2d(2,2))/sqrt(2._dp)
mat1a(2,3) = 0._dp 
mat1a(2,3) = mat1a(2,3)+(v1*Y1d(2,3))/sqrt(2._dp)
mat1a(2,3) = mat1a(2,3)+(v2*Y2d(2,3))/sqrt(2._dp)
mat1a(3,1) = 0._dp 
mat1a(3,1) = mat1a(3,1)+(v1*Y1d(3,1))/sqrt(2._dp)
mat1a(3,1) = mat1a(3,1)+(v2*Y2d(3,1))/sqrt(2._dp)
mat1a(3,2) = 0._dp 
mat1a(3,2) = mat1a(3,2)+(v1*Y1d(3,2))/sqrt(2._dp)
mat1a(3,2) = mat1a(3,2)+(v2*Y2d(3,2))/sqrt(2._dp)
mat1a(3,3) = 0._dp 
mat1a(3,3) = mat1a(3,3)+(v1*Y1d(3,3))/sqrt(2._dp)
mat1a(3,3) = mat1a(3,3)+(v2*Y2d(3,3))/sqrt(2._dp)
...
Subroutine OneLoopFu(Y1u,Y2u,v1,v2,MFu,MFu2,MAh,MAh2,MHm,MHm2,MFd,MFd2,               & 
...
Complex(dp), Intent(in) :: Y1u(3,3),Y2u(3,3)
...
mat1a(1,1) = 0._dp 
mat1a(1,1) = mat1a(1,1)+(v1*Y1u(1,1))/sqrt(2._dp)
mat1a(1,1) = mat1a(1,1)+(v2*Y2u(1,1))/sqrt(2._dp)
mat1a(1,2) = 0._dp 
mat1a(1,2) = mat1a(1,2)+(v1*Y1u(1,2))/sqrt(2._dp)
mat1a(1,2) = mat1a(1,2)+(v2*Y2u(1,2))/sqrt(2._dp)
mat1a(1,3) = 0._dp 
mat1a(1,3) = mat1a(1,3)+(v1*Y1u(1,3))/sqrt(2._dp)
mat1a(1,3) = mat1a(1,3)+(v2*Y2u(1,3))/sqrt(2._dp)
mat1a(2,1) = 0._dp 
mat1a(2,1) = mat1a(2,1)+(v1*Y1u(2,1))/sqrt(2._dp)
mat1a(2,1) = mat1a(2,1)+(v2*Y2u(2,1))/sqrt(2._dp)
mat1a(2,2) = 0._dp 
mat1a(2,2) = mat1a(2,2)+(v1*Y1u(2,2))/sqrt(2._dp)
mat1a(2,2) = mat1a(2,2)+(v2*Y2u(2,2))/sqrt(2._dp)
mat1a(2,3) = 0._dp 
mat1a(2,3) = mat1a(2,3)+(v1*Y1u(2,3))/sqrt(2._dp)
mat1a(2,3) = mat1a(2,3)+(v2*Y2u(2,3))/sqrt(2._dp)
mat1a(3,1) = 0._dp 
mat1a(3,1) = mat1a(3,1)+(v1*Y1u(3,1))/sqrt(2._dp)
mat1a(3,1) = mat1a(3,1)+(v2*Y2u(3,1))/sqrt(2._dp)
mat1a(3,2) = 0._dp 
mat1a(3,2) = mat1a(3,2)+(v1*Y1u(3,2))/sqrt(2._dp)
mat1a(3,2) = mat1a(3,2)+(v2*Y2u(3,2))/sqrt(2._dp)
mat1a(3,3) = 0._dp 
mat1a(3,3) = mat1a(3,3)+(v1*Y1u(3,3))/sqrt(2._dp)
mat1a(3,3) = mat1a(3,3)+(v2*Y2u(3,3))/sqrt(2._dp)
...
Subroutine OneLoopFe(Y1e,Y2e,v1,v2,MFe,MFe2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,               & 
...
Complex(dp), Intent(in) :: Y1e(3,3),Y2e(3,3)
...
mat1a(1,1) = 0._dp 
mat1a(1,1) = mat1a(1,1)+(v1*Y1e(1,1))/sqrt(2._dp)
mat1a(1,1) = mat1a(1,1)+(v2*Y2e(1,1))/sqrt(2._dp)
mat1a(1,2) = 0._dp 
mat1a(1,2) = mat1a(1,2)+(v1*Y1e(1,2))/sqrt(2._dp)
mat1a(1,2) = mat1a(1,2)+(v2*Y2e(1,2))/sqrt(2._dp)
mat1a(1,3) = 0._dp 
mat1a(1,3) = mat1a(1,3)+(v1*Y1e(1,3))/sqrt(2._dp)
mat1a(1,3) = mat1a(1,3)+(v2*Y2e(1,3))/sqrt(2._dp)
mat1a(2,1) = 0._dp 
mat1a(2,1) = mat1a(2,1)+(v1*Y1e(2,1))/sqrt(2._dp)
mat1a(2,1) = mat1a(2,1)+(v2*Y2e(2,1))/sqrt(2._dp)
mat1a(2,2) = 0._dp 
mat1a(2,2) = mat1a(2,2)+(v1*Y1e(2,2))/sqrt(2._dp)
mat1a(2,2) = mat1a(2,2)+(v2*Y2e(2,2))/sqrt(2._dp)
mat1a(2,3) = 0._dp 
mat1a(2,3) = mat1a(2,3)+(v1*Y1e(2,3))/sqrt(2._dp)
mat1a(2,3) = mat1a(2,3)+(v2*Y2e(2,3))/sqrt(2._dp)
mat1a(3,1) = 0._dp 
mat1a(3,1) = mat1a(3,1)+(v1*Y1e(3,1))/sqrt(2._dp)
mat1a(3,1) = mat1a(3,1)+(v2*Y2e(3,1))/sqrt(2._dp)
mat1a(3,2) = 0._dp 
mat1a(3,2) = mat1a(3,2)+(v1*Y1e(3,2))/sqrt(2._dp)
mat1a(3,2) = mat1a(3,2)+(v2*Y2e(3,2))/sqrt(2._dp)
mat1a(3,3) = 0._dp 
mat1a(3,3) = mat1a(3,3)+(v1*Y1e(3,3))/sqrt(2._dp)
mat1a(3,3) = mat1a(3,3)+(v2*Y2e(3,3))/sqrt(2._dp)
...
& cplcUFvFecHmR,cplcUFvFecVWmL,cplcUFvFecVWmR,cplcUFvFvVPL,cplcUFvFvVPR,cplcUFvFvVZL,    & 
& cplcUFvFvVZR,sigL,sigR,sigSL,sigSR)
...
& cplcUFvFvVPL(3,3),cplcUFvFvVPR(3,3),cplcUFvFvVZL(3,3),cplcUFvFvVZR(3,3)
...
coupL1 = cplcUFvFvVPL(gO1,i2)
coupR1 = cplcUFvFvVPR(gO1,i2)
coupL2 =  Conjg(cplcUFvFvVPL(gO2,i2))
coupR2 =  Conjg(cplcUFvFvVPR(gO2,i2))
SumSL(gO1,gO2) = coupL1*coupR2*B0m2 
SumSR(gO1,gO2) = coupR1*coupL2*B0m2 
sumR(gO1,gO2) = coupL1*coupL2*B1m2 
sumL(gO1,gO2) = coupR1*coupR2*B1m2 
...
coupL1 = cplcFvFvVPL(i1,i2)
coupR1 = cplcFvFvVPR(i1,i2)
    SumI = (Abs(coupL1)**2+Abs(coupR1)**2)*H0m2 & 
                & + (Real(Conjg(coupL1)*coupR1,dp))*B0m2 
res = res +1._dp* SumI  
End If 
...
& cplcFeFeVPR,cplcFuFuVPL,cplcFuFuVPR,cplcFvFvVPL,cplcFvFvVPR,cplcgWmgWmVP,              & 
...
& cplcgWmgWmVZ,cplcgWpgWpVZ,cplhhVPVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcVWmVWmVZ,     & 
...
& cplcFvFecVWmL,cplcFvFecVWmR,cplcgWpgAcVWm,cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgWpgZcVWm,   & 
...
& cplcFeFeVZR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFvVPL,               & 
& cplcFvFvVPR,cplcFvFvVZL,cplcFvFvVZR,cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWpgWpVP,            & 
& cplcgWpgWpVZ,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVPVWmVZ1,cplcVWmVPVWmVZ2,     & 
& cplcVWmVPVWmVZ3,cplcVWmVWmVZ,cplhhhhVPVZ,cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,               & 
...
& cplcFvFvVPL(3,3),cplcFvFvVPR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcgWmgWmVP,      & 
& cplcgWmgWmVZ,cplcgWpgWpVP,cplcgWpgWpVZ,cplcHmVPVWm(2),cplcHmVWmVZ(2),cplcVWmVPVWm,     & 
& cplcVWmVPVWmVZ1,cplcVWmVPVWmVZ2,cplcVWmVPVWmVZ3,cplcVWmVWmVZ,cplhhhhVPVZ(3,3),         & 
...
coupL1 = cplcFvFvVPL(i1,i2)
coupR1 = cplcFvFvVPR(i1,i2)
coupL2 = cplcFvFvVZL(i2,i1)
coupR2 = cplcFvFvVZR(i2,i1)
    SumI = (coupL1*coupL2+coupR1*coupR2)*H0m2 & 
                & + 0.5_dp*(coupL1*coupR2 + coupL2*coupR1)*B0m2 
res = res +1._dp* SumI  
      End Do 
...
& cplcgAgWpVWm,cplcgWmgZVWm,cplcgWpgAcHm,cplcgWpgZcHm,cplcgZgWmcHm,cplcgZgWpVWm,         & 
...
& cplcFvFecHmL(3,3,2),cplcFvFecHmR(3,3,2),cplcgAgWpVWm,cplcgWmgZVWm,cplcgWpgAcHm(2),     & 
& cplcgWpgZcHm(2),cplcgZgWmcHm(2),cplcgZgWpVWm,cplcHmVPVWm(2),cplcHmVWmVZ(2),            & 
...
End Module LoopMasses_BGLNCS_stripped 
